...
for lang_code, lang_name in languages.items():
    if lang_code == 'en':
        continue  # Skip English, we'll create it manually
...
# Write batch file
batch_file = '/Users/dustinfields/git/i2p.www/scripts/batches/i18n_feedback.jsonl'
...
batch = client.batches.create(
    ...
    metadata={"description": "I2P feedback layout i18n translations"}
)
...
# Save batch ID
with open('/Users/dustinfields/git/i2p.www/scripts/i18n_feedback_batch_id.txt', 'w') as f:
    f.write(batch.id)
