...
# All the hardcoded strings in the layout
layout_strings = {
...
for lang_code, lang_name in languages.items():
    for string_key, string_value in layout_strings.items():
        batch_requests.append({
            "custom_id": f"getinvolved_{lang_code}_{string_key}",
            "method": "POST",
...
# Write batch file
batch_file = '/Users/dustinfields/git/i2p.www/scripts/batches/get_involved_layout.jsonl'
...
batch = client.batches.create(
    ...
    metadata={"description": "I2P get-involved layout i18n"}
)
...
# Save batch ID
with open('/Users/dustinfields/git/i2p.www/scripts/get_involved_layout_batch_id.txt', 'w') as f:
    f.write(batch.id)
