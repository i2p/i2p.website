...
date: 2012-07-30
author: "zzz"
description: "Версия 0.9.1 включает множество исправлений ошибок в i2psnark, ряд улучшений в streaming lib (библиотеке потоковой передачи данных), изменения на домашней странице, новые темы оформления и обновления переводов."
categories: ["release"]
---

0.9.1 включает большое количество исправлений ошибок в i2psnark, некоторые улучшения в streaming lib (библиотеке потоковой передачи), изменения на домашней странице, новые темы оформления и обновления переводов. Рекомендуется обновление.
