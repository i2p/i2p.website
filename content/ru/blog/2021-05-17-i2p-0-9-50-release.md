...
date: 2021-05-17
author: "zzz"
description: "0.9.50 с исправлениями для IPv6"
categories: ["release"]
---

## Сведения об обновлении

0.9.50 продолжает переход на ECIES-X25519 для ключей шифрования router. Мы включили DNS over HTTPS для reseeding (начальной загрузки пиров), чтобы защитить пользователей от пассивного перехвата DNS-запросов. Внесено множество исправлений и улучшений для адресов IPv6, включая новую поддержку UPnP.

Мы наконец исправили некоторые давние ошибки повреждения данных в SusiMail. Изменения в ограничителе пропускной способности должны улучшить производительность tunnel в сети. Мы внесли несколько улучшений в наши контейнеры Docker. Мы улучшили нашу защиту от возможных вредоносных и некорректно работающих routers в сети.
...
[Полный список исправленных ошибок](http://trac.i2p2.i2p/query?resolution=fixed&milestone=0.9.50)
