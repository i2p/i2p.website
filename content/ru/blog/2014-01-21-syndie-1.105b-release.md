---
title: "Выпуск Syndie 1.105b"
date: 2014-01-21
author: "zzz"
description: "Обновление до HSQLDB 2.3.1"
categories: ["release"]
---

Это первый стабильный релиз с февраля 2013 года. По сути он такой же, как 1.104b-7-rc, с некоторыми обновлениями переводов.

Все двоичные файлы и пакеты исходного кода доступны на [syndie.de](https://syndie.de/download) и [syndie.i2p](http://www.syndie.i2p/download.html). Плагины доступны на [plugins.i2p](http://plugins.i2p/plugins/syndie/) и [stats.i2p](http://stats.i2p/i2p/plugins/).
