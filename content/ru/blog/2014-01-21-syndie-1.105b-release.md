...
Все двоичные файлы и пакеты исходного кода доступны на [syndie.de](https://syndie.de/download) и [syndie.i2p](http://www.syndie.i2p/downloads/). Плагины доступны на [plugins.i2p](http://plugins.i2p/plugins/syndie/) и [stats.i2p](http://stats.i2p/i2p/plugins/).
