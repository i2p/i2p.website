...
date: 2020-11-30
author: "zzz"
description: "0.9.48 с улучшениями производительности"
categories: ["release"]
---
...
Пакеты для Ubuntu Xenial (16.04 LTS) больше не поддерживаются. Если вы используете эту платформу, обновитесь, чтобы продолжать получать обновления I2P.
...
[Полный список исправленных ошибок](http://trac.i2p2.i2p/query?resolution=fixed&milestone=0.9.48)
