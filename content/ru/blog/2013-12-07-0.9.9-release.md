...
date: 2013-12-07
author: "zzz"
description: "0.9.9 исправляет ряд ошибок в netdb, streaming и i2ptunnel и начинает работу над годичным планом по повышению стойкости криптографических алгоритмов подписи."
categories: ["release"]
---
...
Теперь мы поддерживаем SSL между вашим router и вашими серверами в целях безопасности. См. [эту тему разработки](http://zzz.i2p/topics/1495) для получения дополнительной информации.
