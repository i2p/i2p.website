...
date: 2015-06-02
author: "zzz"
description: "0.9.20 с улучшениями производительности и исправлениями ошибок"
categories: ["release"]
---
...
Мы надеемся, что эти изменения увеличат пропускную способность и производительность сети и снизят перегрузку, которая в течение последних трёх месяцев влияла на сеть.
...
Наконец, мы рады объявить о нашем первом в истории митапе I2P, который пройдет в Торонто 15–16 августа. Будет много докладов и обучающих сессий. Будем рады всем. Для получения дополнительной информации см. [объявление](/en/blog/2015-06-02-toronto-meetup).
