...
Destinations включены в каждый потоковый SYN [Streaming]_
и подтверждаемую датаграмму [Datagram]_.
Router Infos (содержащие Router Identities) включены в Database Store Messages [I2NP]_
и в сообщения Session Confirmed в [NTCP2]_ и [SSU2]_.
...
но он документирован в Java I2P javadocs [PKF]_
...
### SAM
Примечание в [SAM]_, что закрытый ключ шифрования не используется и может быть проигнорирован.
...
### I2CP
Изменения не требуются в [I2CP]_. Закрытый ключ для открытого ключа шифрования в Destination
...
Для дальнейшего обсуждения см. [PQ]_.
...
Чертеж запроса на слияние для Java I2P находится в [MR]_.
