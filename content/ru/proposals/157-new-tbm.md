...
См. [I2NP](/docs/specs/i2np/) и [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) для окончательной спецификации.
...
Изменения в формате записи размером 528 байт для маршрутизаторов ECIES-X25519 специфицированы в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies).
...
См. [Prop152](/proposals/152-ecies-tunnels/) и [Prop156](/proposals/156-ecies-routers/) для дополнительных целей.

- Меньшие записи и сообщения
- Поддержание достаточного места для будущих опций, как в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies)
- Вписывание в одно туннельное сообщение для обратного пути
- Поддержка только узлов ECIES
- Поддержание улучшений, реализованных в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies)
...
См. [Prop156](/proposals/156-ecies-routers/) для дополнительных не-целей.

- Отсутствие требования для смешанных туннелей ElGamal/ECIES
- Изменения шифрования слоя, для этого см. [Prop153](/proposals/153-chacha20-layer-encryption/)
...
и записями ECIES, определенными в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies), которые занимают 464 байта.

Записи нешифрованного ответа будут занимать 202 байта,
по сравнению с записями ElGamal, которые занимают 496 байт,
и записями ECIES, определенными в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies), которые занимают 512 байт.
...
Шифрование записей запроса и ответа: как определено в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies).
...
Обзор изменений из [Tunnel-Creation-ECIES](/docs/specs/implementation/#tunnel-creation-ecies):
...
Поле флагов такое же как определено в [Tunnel-Creation](/docs/specs/implementation/#tunnel-creation-ecies) и содержит следующее:
...
Параметры построения туннеля - это структура Mapping, как определено в [Common](/docs/specs/common-structures/).
...
Параметры ответа на построение туннеля - это структура Mapping, как определено в [Common](/docs/specs/common-structures/).
Это для будущего использования. На данный момент не определено никаких параметров.
Если структура Mapping пуста, это два байта 0x00 0x00.
...
как определено в [Tunnel-Creation](/docs/specs/implementation/#tunnel-creation-ecies) для предотвращения фингерпринтинга:
