...
Наши спецификации [SSU](/en/docs/transport/ssu/) и [SSU-SPEC](/en/docs/spec/ssu/) содержат ошибки и несоответствия относительно поддержки
...
Наши спецификации [SSU](/en/docs/transport/ssu/) и [SSU-SPEC](/en/docs/spec/ssu/) ясно указывают, что вводные устройства IPv6 не поддерживаются.
...
[SSU](/en/docs/transport/ssu/) в настоящий момент говорит (заметки по IPv6):
...
[SSU-SPEC](/en/docs/spec/ssu/) в данный момент говорит (Relay Request):
...
[SSU](/en/docs/transport/ssu/) в данный момент говорит (заметки по IPv6):
...
[SSU-SPEC](/en/docs/spec/ssu/) в данный момент говорит (Relay Response):
...
[SSU-SPEC](/en/docs/spec/ssu/) в данный момент говорит (Relay Intro):
