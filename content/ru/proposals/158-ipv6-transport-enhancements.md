...
Наши спецификации [SSU]_ и [SSU-SPEC]_ содержат ошибки и несоответствия относительно поддержки
...
Наши спецификации [SSU]_ и [SSU-SPEC]_ ясно указывают, что вводные устройства IPv6 не поддерживаются.
...
[SSU]_ в настоящий момент говорит (заметки по IPv6):
...
[SSU-SPEC]_ в данный момент говорит (Relay Request):
...
[SSU]_ в данный момент говорит (заметки по IPv6):
...
[SSU-SPEC]_ в данный момент говорит (Relay Response):
...
[SSU-SPEC]_ в данный момент говорит (Relay Intro):
