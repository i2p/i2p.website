...
и его примерном приложении "dmprinter" [JRAFT]_.
JRaft — это реализация протокола Raft [RAFT]_.
...
Мы будем использовать рукопожатие, похожее на websocket [WEBSOCKET]_ и
аутентификацию HTTP Digest [RFC-2617]_.
Базовая аутентификация RFC 2617 НЕ поддерживается.
При проксировании через HTTP-прокси, мы общаемся с
прокси, как указано в [RFC-2616]_.
...
Инициатор отправит следующее,
как в [RFC-2617]_ и [WEBSOCKET]_.
...
Содержимое приложения кодируется в UTF-8 [JSON]_.
