...
с IPv6. Открытый тикет 1050 http://trac.i2p2.i2p/ticket/1050 описывает некоторые из проблем.
...
Соответствующий раздел - "Спецификация адреса маршрутизатора" в спецификациях транспорта:
