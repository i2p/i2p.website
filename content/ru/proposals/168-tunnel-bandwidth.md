...
спецификацию [Tunnel-Creation-ECIES] с API 0.9.65.
...
Добавьте параметры пропускной способности к записям в сообщениях создания туннеля ECIES [Tunnel-Creation-ECIES]_
...
Обновите спецификацию сообщений создания туннеля ECIES [Tunnel-Creation-ECIES]_
следующим образом:
