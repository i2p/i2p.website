...
- Предложение 136 экспериментальные типы сигнатур /proposals/136-experimental-sigtypes/
- Предложение 137 опциональные типы сигнатур /proposals/137-optional-sigtypes/
- Темы обсуждения здесь для каждого из вышеуказанных предложений, ссылки внутри
- http://zzz.i2p/topics/2494 приоритеты предложений 2018 года
- http://zzz.i2p/topics/2418 предложение ECIES
- http://zzz.i2p/topics/1768 обзор нового асимметричного шифрования
- Обзор криптографии низкого уровня /docs/specs/cryptography/
