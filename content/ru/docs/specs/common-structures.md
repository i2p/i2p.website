...
- Спецификации сжимаемого padding (дополнение) завершены ([Proposal 161](/proposals/161-ri-dest-padding/), реализовано в 0.9.57)
...
```
### Рекомендации по генерации заполнения ([Предложение 161](/proposals/161-ri-dest-padding/))
...
3. **Типичный размер:**
   ...
   - 320 байт заполнения (сжимаемого согласно [Proposal 161](/proposals/161-ri-dest-padding/))
...
**См. также:** - Рекомендации по генерации заполнения ([Proposal 161](/proposals/161-ri-dest-padding/)) - Спецификация Key Certificate (сертификата ключа) выше
...
2. **Ключ шифрования:**
   ...
   - **Рекомендуется:** заполнить случайными данными в соответствии с [Предложением 161](/proposals/161-ri-dest-padding/) (сжимаемыми)
...
**Обратная совместимость:** - ElGamal и DSA_SHA1 по-прежнему поддерживаются для устаревших routers - Типы ключей, помеченные как устаревшие, остаются работоспособными, но их использование не рекомендуется - Сжимаемый padding (выравнивающая вставка) ([Proposal 161](/proposals/161-ri-dest-padding/)) обратно совместим вплоть до 0.6
...
- [Предложение 161: Генерация паддинга](/proposals/161-ri-dest-padding/)
