...
Tous les binaires et les paquets source sont disponibles sur [syndie.de](https://syndie.de/download) et [syndie.i2p](http://www.syndie.i2p/download.html). Les plugins sont disponibles sur [plugins.i2p](http://plugins.i2p/plugins/syndie/) et [stats.i2p](http://stats.i2p/i2p/plugins/).
