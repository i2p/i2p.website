...
date: 2012-07-30
author: "zzz"
description: "0.9.1 inclut un grand nombre de corrections de bogues dans i2psnark, quelques améliorations de la streaming lib (bibliothèque de streaming), des modifications de la page d’accueil, de nouveaux thèmes et des mises à jour des traductions."
categories: ["release"]
---

La version 0.9.1 comprend un grand nombre de corrections de bogues dans i2psnark, quelques améliorations de streaming lib (bibliothèque de streaming), des modifications de la page d’accueil, de nouveaux thèmes et des mises à jour des traductions. La mise à jour est recommandée.
