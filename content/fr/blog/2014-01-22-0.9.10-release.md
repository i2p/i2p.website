...
date: 2014-01-22
author: "zzz"
description: "La version 0.9.10 modifie le mécanisme de recherche des LeaseSet, rendant plus difficile pour un attaquant de corréler une Destination avec un Router."
categories: ["release"]
---

La version 0.9.10 modifie le mécanisme de recherche de LeaseSet, rendant plus difficile pour un attaquant de corréler une Destination avec un Router. Elle corrige également des bogues d’encodage de caractères dans susimail, et inclut de nombreux autres correctifs et des mises à jour de traduction. La plupart d’entre vous mettront à jour via torrent, en utilisant le nouveau format de mise à jour "su3" avec des clés plus fortes.

Nous avons récemment assisté à [30C3](https://events.ccc.de/congress/2013/wiki/Main_Page) et à [Real World Crypto](http://realworldcrypto.wordpress.com/), établissant plusieurs nouveaux contacts et élaborant de [grands projets](http://zzz.i2p) pour 2014. Merci à celles et ceux qui ont soutenu notre présence grâce à leurs [dons](http://i2p-projekt.i2p/donate) !
