...
résistance de [NTCP]_ à diverses formes d'identification automatique et d'attaques.
...
Les données [NTCP]_ sont chiffrées après le premier message (et le premier message
...
un protocole existant tel que TLS, mais c'est [Prop104]_ qui a ses
...
- Supporter NTCP 1 et 2 sur un seul port, autodétecter, et publier comme un seul
  "transport" (c’est-à-dire [RouterAddress]_) dans le [NetDB]_.
...
- Corriger la perte de bits dans DH due à la format Java [Ticket1112]_, éventuellement (probablement?)
  en passant à X25519.
...
- Continuer à utiliser les signatures de type variable, de longueur variable (de la
  clé de signature [RouterIdentity]_ publiée) comme une partie de l'authentification. Compter
...
- Si possible, réduire la poignée de main à 4 messages et deux allers-retours à une poignée de main
  à 3 messages et un aller-retour, comme dans [SSU]_. Cela nécessiterait de déplacer la
