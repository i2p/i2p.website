...
Cette proposition décrit un protocole d'accord de clés authentifié pour améliorer la résistance de [NTCP](/docs/ntcp/) à diverses formes d'identification automatisée et d'attaques.
...
- Un transport basé sur TLS (ou ressemblant à HTTPS)... qui serait [Prop104](/proposals/104-tls-transport/).
