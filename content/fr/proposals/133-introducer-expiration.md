...
Cette proposition concerne l'amélioration du taux de succès pour les introductions. Voir
[TRAC-TICKET]_.
...
[RouterInfo]_. Les routeurs doivent actuellement utiliser des heuristiques pour estimer quand un
introducteur n'est plus valide.


## Conception

Dans une [RouterAddress]_ SSU contenant des introducteurs, l'éditeur peut éventuellement
...
Notes
`````
* Chaque expiration doit être supérieure à la date de publication du [RouterInfo]_,
...
* Les expirations d'introducteur sont dans le mappage [RouterAddress]_.
  Elles ne sont pas le champ d'expiration de 8 octets (actuellement inutilisé) dans le [RouterAddress]_.
