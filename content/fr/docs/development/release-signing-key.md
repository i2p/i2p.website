---
title: "Clé de signature des versions"
description: "Clés PGP utilisées pour signer les versions d'I2P et où les obtenir"
slug: "release-signing-key"
lastUpdated: "2025-10"
accurateFor: "2.10.0"
type: docs
aliases:
  - "/docs/develop/release-signing-key/"
---

<p> Les versions 0.9.57 et suivantes sont signées par idk. Sa clé publique actuelle est : </p> <p> <a href="/idk.key.asc" >Télécharger la clé publique PGP</a> </p><p>

<p> Les versions 0.7.6 et 0.9.56 sont signées par zzz. Sa clé publique actuelle est : </p> <p> <a href="/zzz.key.asc" >Télécharger la clé publique PGP</a> </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1

J'ai créé de nouvelles clés GPG et sous-clés et j'ai signé les nouvelles clés avec l'ancienne clé.
...
J'utiliserai les nouvelles clés comme suit :
...
La clé de signature des versions sera utilisée à partir de la version 0.9.13. Ce message est signé avec mon ancienne clé.
...
<p> Les versions à partir de 0.9.9 peuvent être signées par str4d. Sa clé publique actuelle est : </p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA512

Mes clés publiques actuelles sont les suivantes :

pub   4096R/0EC51FCDA94FB53E 2014-03-11 [expire : 2019-03-10] uid               [  complet  ] str4d (http://str4d.i2p) <str4d@mail.i2p> uid               [  complet  ] str4d <str4d@i2pmail.org> sub   4096R/1CC61D9B33C3241B 2014-03-11 [expiré : 2015-03-11] sub   4096R/803DEE491A3473E7 2014-03-12 [expiré : 2015-03-12] sub   4096R/A1B84C9B733AAC82 2015-04-05 [expire : 2016-04-04] sub   4096R/13B5EE58C09FB3E0 2015-04-05 [expire : 2016-04-04]

J'utilise actuellement les clés comme suit :

        A94FB53E: key signing
        733AAC82: email encryption
        C09FB3E0: email and release signing

Je génère de nouvelles sous-clés de chiffrement et de signature chaque année. Toute version d'I2P signée par moi sera toujours signée avec la dernière sous-clé de signature disponible au moment de la publication.
...
<p> str4d a signé les versions suivantes : </p> <ul> <li>0.9.23</li> </ul>

<p> Les versions 0.7.6 à 0.9.12 ont été signées par zzz avec la clé suivante : </p> <p> <pre> -----BEGIN PGP PUBLIC KEY BLOCK----- Version: GnuPG v1.4.6 (GNU/Linux)
...
</pre> <p> Les versions 0.6.1.31 à 0.7.5 ont été signées par Complication. Sa clé publique est : </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1

Bonjour,

Je certifie que ci-dessous se trouve ma nouvelle clé publique, émise le 24/11/2007, valide jusqu'au 23/11/2009, et son empreinte de clé est :

73CF 2862 87A7 E7D2 19FF DB66 FA1D FC6B 79FC CE33

Si vous avez mon ancienne clé publique et que vous l'utilisez pour vérifier ceci, vous remarquerez que mon ancienne clé a expiré le 15-11-2007. Toutes mes excuses pour ce retard dans la mise à jour.

Pour les personnes qui souhaitent copier la clé directement depuis ce message, mais qui ne lisent pas ceci via un programme de messagerie électronique, n'oubliez pas de supprimer les séquences d'échappement "- " du marqueur de début et de fin du bloc de clé publique. Sinon, elle ne sera pas reconnue.
