...
I2P prend en charge une [interface de plugins](/docs/plugins/) standard pour les développeurs afin que les applications puissent être facilement intégrées et distribuées.
