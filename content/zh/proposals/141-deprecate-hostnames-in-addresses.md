...
在 Java I2P 中，一直以来都是一个挑战，将配置的主机名传播到已发布的传输中，并且随着 IPv6 的出现，问题变得更加复杂。开放票据 1050 http://trac.i2p2.i2p/ticket/1050 详细描述了一些问题。不清楚一个双栈主机是否应该同时发布一个主机名和一个字面 IPv6 地址。主机名是在 SSU 地址中发布的，而不是在 NTCP 地址中。
