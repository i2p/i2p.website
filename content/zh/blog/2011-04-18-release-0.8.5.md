...
date: 2011-04-18
author: "zzz"
description: "0.8.5 版本包含一些错误修复和性能改进，以及大量的翻译更新。"
categories: ["release"]
---

0.8.5 版本包含一些缺陷修复和性能改进，以及大量的翻译更新。一如既往，建议升级。

请帮助壮大网络。[参与贡献](http://www.i2p2.de/getinvolved.html)、传播信息，并[捐助](http://www.i2p2.de/donate.html)！如果你发现了 bug，请在[gitlab](http://i2pgit.org/i2p-hackers/i2p.i2p/issues)上提交报告。我们仍在寻求对新旧翻译的帮助。请在 IRC 的 #i2p-dev 频道报名成为志愿者。
