...
所有二进制文件和源代码包可在 [syndie.de](https://syndie.de/download) 和 [syndie.i2p](http://www.syndie.i2p/download.html) 获取。插件可在 [plugins.i2p](http://plugins.i2p/plugins/syndie/) 和 [stats.i2p](http://stats.i2p/i2p/plugins/) 获取。
