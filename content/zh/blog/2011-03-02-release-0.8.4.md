...
date: 2011-03-02
author: "zzz"
description: "0.8.4 版本包含了一些性能改进和重要的错误修复。另外，i2psnark 现在支持磁力链接。"
categories: ["release"]
---

0.8.4 版本包含一些性能改进和重要的错误修复。此外，i2psnark 现在支持磁力链接。一如既往，建议升级。

请帮助壮大网络。[参与其中](http://www.i2p2.de/getinvolved.html)、宣传推广，并[捐助](http://www.i2p2.de/donate.html)！如果你发现了 bug，请在[gitlab](http://i2pgit.org/i2p-hackers/i2p.i2p/issues)提交报告。我们仍在为新增和已有的翻译寻找帮助。请在 IRC #i2p-dev 报名成为志愿者。
