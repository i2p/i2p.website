...
Resmi taslak için [SPEC]_ kısmına bakınız.
...
Bu teklifin tanımladığı imza şeması, Red25519, anahtar yeniden rastgeleleştirmeyi destekleyen Schnorr tabanlı bir imza şeması olan [RedDSA]_ uygulamasıdır. Şu işlevleri vardır:
...
B
    [RFC-8032]_'de olduğu gibi Ed25519 baz noktası.

L
    Ed25519'un 2^252 + 27742317777372353535851937790883648493 düzeni [RFC-8032]_ olarak verilmiştir.
...
Uygulama kolaylığı açısından, zaten Red25519'a özelleştirilmiş RedDSA işlevlerini (ve birkaç yardımcı işlevi) açıkça aşağıda yazarız. Uygulayıcılar, [RedDSA]_ bölümü 5.4.6'ya bakmalıdır.
...
``CONVERT_ED25519_PRIVATE`` işlevinin uygulanmasının, özel bir Ed25519 anahtarından Ed25519 genel anahtarı türetirken gizli skaler s'nin hesaplanmasına eşdeğer olduğunu, [RFC-8032]_ bölüm 5.1.5'teki adımlardan 1-3'te belirtildiği gibi olduğunu not edin.
