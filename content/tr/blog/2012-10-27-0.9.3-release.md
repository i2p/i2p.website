...
date: 2012-10-27
author: "zzz"
description: "0.9.3, router içindeki mesajların kuyruklanmasına ilişkin kapsamlı düşük düzeyli değişiklikler içerir. CoDel Etkin Kuyruk Yönetimi (AQM) algoritmasını uyguluyoruz."
categories: ["release"]
---

0.9.3, router içindeki iletilerin kuyruklanmasına ilişkin kapsamlı alt düzey değişiklikler içeriyor. CoDel Active Queue Management (AQM, Etkin Kuyruk Yönetimi) algoritmasını uyguluyoruz. Ayrıca, tanılamaya yardımcı olmak ve ağ gecikmesini azaltmak için transports (taşıma katmanları) içindeki kuyruklama ve önceliklendirme mekanizmalarını birleştiriyoruz. UDP transport hatalarını düzeltme ve UDP'yi saldırılara karşı daha dayanıklı hale getirme çalışmaları sürüyor. Router performansını iyileştirmek ve bellek kullanımını azaltmak için daha fazla değişiklik var. Ayrıca, önceki sürümde tanıtılan i2psnark'ın DHT desteğini varsayılan olarak etkinleştiriyoruz.

Her zamanki gibi, bu sürümde de çok sayıda hata düzeltmesi var, bu nedenle güncelleme yapmanız önerilir.
