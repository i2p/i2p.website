...
Tüm ikili dosyalar ve kaynak paketler [syndie.de](https://syndie.de/download) ve [syndie.i2p](http://www.syndie.i2p/downloads/) adreslerinde bulunmaktadır. Eklentiler [plugins.i2p](http://plugins.i2p/plugins/syndie/) ve [stats.i2p](http://stats.i2p/i2p/plugins/) adreslerinde mevcuttur.
