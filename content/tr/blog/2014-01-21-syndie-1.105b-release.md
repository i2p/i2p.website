---
title: "Syndie 1.105b Sürümü"
date: 2014-01-21
author: "zzz"
description: "HSQLDB 2.3.1'e güncelleme"
categories: ["release"]
---

Bu, Şubat 2013’ten bu yana ilk kararlı sürümdür. Esasen 1.104b-7-rc ile aynıdır, bazı çeviri güncellemeleriyle birlikte.

Tüm ikili dosyalar ve kaynak paketler [syndie.de](https://syndie.de/download) ve [syndie.i2p](http://www.syndie.i2p/download.html) adreslerinde bulunmaktadır. Eklentiler [plugins.i2p](http://plugins.i2p/plugins/syndie/) ve [stats.i2p](http://stats.i2p/i2p/plugins/) adreslerinde mevcuttur.

1.103b sürümünden yükseltme yapıyorsanız, HSQLDB'nin yeni sürümü sayesinde syndie'nin başlatma ve kapatma işlemlerinin çok daha hızlı olduğunu fark edeceksiniz.

Eğer büyük bir veritabanınız veya korumak istediğiniz bir kimliğiniz varsa, başlamadan önce ~/.syndie dizininizin tamamını yedeklemek isteyebilirsiniz. Yükseltme işlemi kendi yedeğini oluşturur, ancak yükseltme başarısız olursa kendi yedeğinizi kullanmanın daha kolay olduğunu düşünebilirsiniz.

Eski HSQLDB'deki hatalardan kaynaklanan veritabanı bozulması nedeniyle, bazı kullanıcılar için 1.103b’den yapılan yükseltmeler başarısız olabilir. Ne yazık ki bunu nasıl düzelteceğimizi bilmiyoruz. Seçenekleriniz ya temiz bir veritabanıyla en baştan başlamak ya da sonsuza kadar 1.103b sürümünde kalmaktır. Bunun için üzgünüz.
...
### GUI İyileştirmeleri ve Düzeltmeleri
