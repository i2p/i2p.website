---
title: "Podpisový klíč vydání"
description: "PGP klíče používané k podepisování vydání I2P a kde je získat"
...
<p> Vydání 0.9.57 a novější jsou podepsána idk. Jeho aktuální veřejný klíč je: </p> <p> <a href="/idk.key.asc" >Stáhnout veřejný PGP klíč</a> </p><p>

<p> Verze 0.7.6 a 0.9.56 jsou podepsány zzz. Jeho aktuální veřejný klíč je: </p> <p> <a href="/zzz.key.asc" >Stáhnout veřejný klíč PGP</a> </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1

Vytvořil jsem nové GPG klíče a podklíče a podepsal jsem nové klíče starým klíčem.
...
Podpisový klíč pro vydání bude použit počínaje verzí 0.9.13. Tato zpráva je podepsána mým starým klíčem.
...
<p> Vydání od 0.9.9 mohla být podepsána uživatelem str4d. Jeho aktuální veřejný klíč je: </p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA512
...
Každoročně generuji nové šifrovací a podepisovací podklíče. Každé vydání I2P, které jsem podepsal, bude vždy podepsáno nejnovějším podepisovacím podklíčem platným v době vydání.
...
<p> str4d podepsal následující vydání: </p> <ul> <li>0.9.23</li> </ul>

<p> Vydání 0.7.6 až 0.9.12 byla podepsána uživatelem zzz následujícím klíčem: </p> <p> <pre> -----BEGIN PGP PUBLIC KEY BLOCK----- Version: GnuPG v1.4.6 (GNU/Linux)
...
</pre> <p> Verze 0.6.1.31 až 0.7.5 byly podepsány Complicationem. Jeho veřejný klíč je: </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1
...
Pro ty, kteří chtějí zkopírovat klíč přímo z této zprávy, ale nečtou ji pomocí e-mailového programu, nezapomeňte prosím odstranit escape sekvence "- " ze značek začátku a konce bloku veřejného klíče. Jinak nebude rozpoznán.
