---
title: "Vydání I2P 2.4.0 s vylepšeními v oblasti přetížení a zabezpečení NetDB"
date: 2023-12-18
author: "idk"
description: "I2P 2.4.0 Release with Congestion and NetDB Security improvements"
categories: ["release"]
...
Toto vydání, I2P 2.4.0, pokračuje v našem úsilí o zlepšení bezpečnosti a stability sítě I2P. Obsahuje významná vylepšení komponenty Network Database (síťová databáze), zásadní struktury v rámci sítě I2P, která slouží k vyhledávání vašich peerů.

Změny mechanismů pro řešení zahlcení zlepší stabilitu sítě tím, že dají routers možnost ulevit zahlceným protějškům tím, že se jim budou vyhýbat. To pomůže síti omezit dopad tunnel spamu. Také to pomůže síti zotavit se během a po útocích DDoS.

Změny v NetDb také pomáhají zabezpečit jednotlivé routers a aplikace, které je používají. Routers se nyní mohou bránit proti útočníkům tím, že NetDB rozdělí na více "Sub-DB's" (podřízených databází), které používáme k zamezení úniku informací mezi aplikacemi a routerem. To také zlepšuje informace dostupné pro Java routers o jejich aktivitě v NetDB a zjednodušuje naši podporu pro multihomingové aplikace.

Součástí je také řada oprav chyb a vylepšení v aplikacích I2PSnark a SusiMail.

Jako obvykle doporučujeme aktualizovat na tuto verzi. Nejlepší způsob, jak zachovat bezpečnost a pomoci síti, je používat nejnovější verzi.
...
[Úplný seznam opravených chyb](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.4.0)
