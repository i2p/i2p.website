...
date: 2012-12-17
author: "zzz"
description: "0.9.4 obsahuje opravu chyby ovlivňující kapacitu sítě, která byla zavedena ve verzi 0.9.2 a snižovala výkon i spolehlivost sítě."
categories: ["release"]
---

0.9.4 obsahuje opravu chyby ovlivňující kapacitu sítě, zavedené ve verzi 0.9.2, jež snižovala výkon a spolehlivost sítě. Obsahuje také zásadní změny v systému aktualizací v rámci sítě a přidává možnost aktualizovat prostřednictvím torrentů v rámci sítě.

Opravili jsme několik chyb v implementaci DHT v i2psnarku, která byla představena v minulém vydání. Pro ty z vás, kteří používají hesla pro konzoli nebo HTTP proxy, jsme přešli na bezpečnější metodu Digest a zlepšili zabezpečení formulářů konzole.

Pro ty z vás, kteří již používají vývojová sestavení, by se váš router měl automaticky aktualizovat na 0.9.4-0 s využitím nového mechanismu torrentu v rámci sítě. Pro ty, kdo provozují 0.9.3-0, proběhne aktualizace obvyklým způsobem pomocí HTTP v rámci sítě a další informace pro vás budeme mít při vydání 0.9.5.

Soubory jsou k dispozici na [stránce ke stažení](/en/downloads/).
