...
date: 2024-05-15
author: "zzz"
description: "2.5.2 Vydání s opravou HTTP"
categories: ["release"]
API_Translate: pravda
---

I2P 2.5.2 je vydána k opravě chyby zavedené ve verzi 2.5.0, která způsobovala zkrácení některého obsahu HTTP.
...
[Úplný seznam opravených chyb](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.5.2)
