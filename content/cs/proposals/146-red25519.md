...
Viz [SPEC]_ pro oficiální specifikace.
...
[Prop123]_ definuje šifrovaný formát LeaseSet2, který ztělesňuje Princip minima
...
Podpisová schéma popsaná v tomto návrhu, Red25519, je instanciace [RedDSA]_,
...
B
    Základní bod Ed25519 jako v [RFC-8032]_.

L
    Pořadí Ed25519 2^252 + 27742317777372353535851937790883648493 jako v [RFC-8032]_.
...
odkázat na sekci 5.4.6 [RedDSA]_ pro obecnou specifikaci funkcí RedDSA.
...
jak je specifikováno v krocích 1-3 v sekci 5.1.5 [RFC-8032]_.
