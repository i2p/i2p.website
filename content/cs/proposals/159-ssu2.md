...
odolnosti [SSU]_ proti různým formám automatizované identifikace a útoků.
...
Stejně jako [SSU]_, poskytuje i další dvě služby:
...
- Podpora SSU 1 a 2 na jednom portu, automatická detekce a publikování jako jediný
  "přenos" (tj. [RouterAddress]_) v [NetDB]_.
...
- Opravit ztrátu bitů v DH kvůli formátu Java [Ticket1112]_, a urychlit DH
  přechodem na X25519.
...
- Použít 3-zprávový, jednorázový handshake, jako v [NTCP2]_.
  Odstranit zpoždění čekání na datové zprávy, které dělají
  [SSU]_ efektivně dvoukruhový handshake.
...
- Přenos na bázi TLS (nebo podobný HTTPS)... to by byla [Prop104]_.
...
protokolu Station-To-Station (STS) [STS]_. Upozorňujeme, že tento protokol je také základem
protokolu [SSU]_.
...
Následující je zkopírováno z QUIC [RFC-9000]_.
