...
Viz [ECIES]_, [STREAMING-SPEC]_, a [STREAMING-OPTIONS]_.
...
Jak je uvedeno v [STREAMING-OPTIONS]_,
...
Jak je popsáno v [ECIES]_, režie ElGamal pro stávající zprávy relace je
...
Přidat následující změny a upřesnění do části Výběr a Sjednávání MTU v [STREAMING-OPTIONS]_.
Žádné změny v [STREAMING-SPEC]_.
...
Viz [CALCULATION]_ pro vysvětlení, proč je současná hodnota 1730.
Viz [ECIES]_ pro vysvětlení, proč je režie ECIES o 82 bajtů menší než u ElGamal.
