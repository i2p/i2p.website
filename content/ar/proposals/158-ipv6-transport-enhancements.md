...
تحتوي مواصفاتنا [SSU]_ و[SSU-SPEC]_ على أخطاء وعدم تناسق بشأن ما إذا كانت
...
توضح مواصفاتنا [SSU]_ و[SSU-SPEC]_ بوضوح أن
...
[SSU]_ يقول حاليًا (ملاحظات IPv6):
...
[SSU-SPEC]_ يقول حاليًا (طلب التوجيه):
...
[SSU-SPEC]_ يقول حاليًا (استجابة التوجيه):
...
[SSU-SPEC]_ يقول حاليًا (مقدمة التوجيه):
