...
تتضمن الوجهات في كل تدفق SYN [Streaming]_
و الحزم القابلة للرد [Datagram]_.
تتضمن معلومات الراوتر (التي تحتوي على هويات الراوتر) في رسائل قاعدة البيانات المخزنة [I2NP]_
وفي رسائل تأكيد الجلسات في [NTCP2]_ و [SSU2]_.
...
### الهياكل المشتركة
تغيير مواصفات الهياكل المشتركة [COMMON]_
لتحديد أن حقل المفتاح العام 256 بايت للوجهة يتم تجاهله وقد
يحتوي على بيانات عشوائية.

إضافة قسم إلى مواصفات الهياكل المشتركة [COMMON]_
...
لكنها موثقة في وثائق جاڤا I2P [PKF]_
...
### SAM
ملاحظة في [SAM]_ أن المفتاح الخاص للتشفير غير مستخدم ويمكن تجاهله.
...
### I2CP
لا تغييرات مطلوبة لـ [I2CP]_. المفتاح الخاص للمفتاح العام للتشفير في الوجهة
...
طلب دمج مسودة لجاڤا I2P في [MR]_.
