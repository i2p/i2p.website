...
- تم تنفيذ موجهات ECIES اعتبارًا من 0.9.48، راجع [Common]_.
- تم تنفيذ بناء الأنفاق اعتبارًا من 0.9.48، راجع [Tunnel-Creation-ECIES]_.
- تم تنفيذ الرسائل المشفرة للموجهات ECIES اعتبارًا من 0.9.49، راجع [ECIES-ROUTERS]_.
...
تم تحديد الاقتراحات لـ LS2 [Prop123]_ وECIES-X25519-AEAD-Ratchet [Prop144]_
(المحددة الآن في [ECIES]_) استبدال ElGamal بـ ECIES
للوجهات.
...
راجع [Prop152]_ للحصول على أهداف إضافية.
...
راجع [Prop152]_ للحصول على الأهداف غير المرغوب فيها الإضافية.

- لا يوجد حاجة لموجهات ذات مفتاح مزدوج
- التغييرات في تشفير الطبقات، راجع [Prop153]_ لهذا
...
في هويته. راجع مواصفات البنية الشائعة [Common]_.
...
هذا هو التكوين المعياري كما هو محدد في مواصفة البنية الشائعة [Common]_.

هذا هو نفس الطريقة المقترحة لـ ECIES-P256
لأنواع التشفير من 1-3 في الاقتراح 145 [Prop145]_.
...
تتطلب عدة تغييرات لمواصفات إنشاء النفق [Tunnel-Creation]_
...
تم تحديد هذه التغييرات في الاقتراح 152 [Prop152]_.
...
تم تحديد هذه التغييرات في الاقتراح 157 [Prop157]_.
...
ECIES-X25519-AEAD-Ratchet [Prop144]_, المحددة الآن في [ECIES]_.
...
- لا حاجة لتشغيل "مدير مفاتيح جلسة مزدوجة" كما هو موضح في [ECIES]_ للوجهات. الموجهات لديها مفتاح عام واحد فقط.
...
لا يحتاج SKM الخاص بموجهات ECIES إلى SKM ذو حركة بالكامل كما هو محدد في [ECIES]_ للوجهات.
...
في [Prop152]_ لبناء النفق.
سيستخدم نفس صيغة الحمولة كما تم تحديدها في [ECIES]_ للوجهات.
الوضع الثابت صفر (بدون ارتباطات أو جلسات) لنمط IK المحدد في [ECIES]_ لن يتم استخدامه.

ستكون الردود على عمليات البحث مشفرة بعلامة راش إذا طُلبت في عملية البحث.
هذا كما هو موثق في [Prop154]_, المحددة الآن في [I2NP]_.
...
تنفيذًا لردود ECIES كما هو محدد في [Prop152]_.
...
هوية الموجه وشهادة المفتاح: راجع [Common]_.

بناء النفق: راجع [Prop152]_.

رسالة بناء النفق الجديدة: راجع [Prop157]_.


### تشفير الطلب

تشفير الطلب هو نفسه الذي تم تحديده في [Tunnel-Creation-ECIES]_ و [Prop152]_,
...
كما هو محدد في [I2NP]_ و [Prop154]_. يتم استخدام المفتاح والعلامة لتشفير الرد.

لا يتم إنشاء مجموعات العلامات.
لوحة المفاتيح الصفرية المحددة في
ECIES-X25519-AEAD-Ratchet [Prop144]_ و[ECIES]_ لن يتم استخدامها.
...
هذا هو المعيار [NOISE]_ لنمط "N" مع اسم بروتوكول معياري.
هذا هو نفس ما تم تحديده في [Tunnel-Creation-ECIES]_ و [Prop152]_ لرسائل بناء النفق.
...
الحمولة هي نفس صيغة البلوك كما هو معرف في [ECIES]_ و [Prop144]_.
...
كما هو محدد في [I2NP]_ و [Prop154]_.
...
قد يتم إعادة كتابة الاقتراح 145 [Prop145]_ ليكون متوافقًا في الأغلب مع
الاقتراح 152 [Prop152]_.
...
بحلول منتصف 2019 كرد فعل على الاقتراح الذي لم يكتمل 145 [Prop145]_.
...
تنفيذ بناء النفق كما هو محدد في الاقتراح 152 [Prop152]_.
...
كما هو محدد في الاقتراح 144 [Prop144]_.
...
تنفيذ واختبار رسالة بناء النفق الجديدة كما هو محدد في الاقتراح 157 [Prop157]_.
