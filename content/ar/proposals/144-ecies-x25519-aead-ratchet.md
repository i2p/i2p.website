...
هذا اقتراح لنوع جديد من التشفير من النهاية إلى النهاية منذ بداية I2P، لاستبدال ElGamal/AES+SessionTags [Elg-AES]_.

يعتمد على العمل السابق كما يلي:

- المواصفات الهياكل المشتركة [Common]_
- مواصفات [I2NP]_ بما في ذلك LS2
- ElGamal/AES+Session Tags [Elg-AES]_
- نظرة عامة على التشفير غير المتماثل الجديد http://zzz.i2p/topics/1768
- نظرة عامة على التشفير منخفض المستوى [CRYPTO-ELG]_
- ECIES http://zzz.i2p/topics/2418
- [NTCP2]_ [Prop111]_
- 123 إدخال جديد netDB
- 142 قالب تشفير جديد
- بروتوكول [Noise]_
- خوارزمية المضاعف المزدوجة [Signal]_
...
راجع المواصفات الهياكل المشتركة [Common]_.
...
راجع جدول "خصائص الحمولة الأمنية" الخاص بـ Noise في [NOISE]_.
...
تطبيقات الموجه I2P الحالية التي لم تنفذ بعد [NTCP2]_ ([Prop111]_)
...
أنواع التشفير 1-3 مخصصة لـ ECIES-ECDH-AES-SessionTag، راجع الاقتراح 145 [Prop145]_.


### إطار عمل بروتوكول Noise

يوفر هذا الاقتراح المتطلبات بناءً على إطار عمل بروتوكول Noise
[NOISE]_ (الإصدار 34، 2018-07-11).
Noise لديه خصائص مشابهة لبروتوكول Station-To-Station
[STS] والذي يعد أساسًا لبروتوكول [SSU]_.
...
1) يتم ترميز المفاتيح المؤقتة بنصوص واضحة مع [Elligator2]_.
...
تستخدم المصافحات أنماط المصافحة [Noise]_.
...
STREAM
    ChaCha20/Poly1305 AEAD كما هو محدد في [RFC-7539]_.
...
HKDF(salt, ikm, info, n)
    ...
    استخدام HKDF كما هو محدد في [RFC-5869]_، باستخدام دالة التجزئة HMAC SHA-256
    كما هو محدد في [RFC-2104]_. هذا يعني أن طول SALT_LEN هو 32 بايت كحد أقصى.
...
الرسالة الثوم كما هو محدد في [I2NP]_ هي كالتالي.
...
انظر [I2NP]_ للتفاصيل والمواصفات الكاملة.
...
تشبه رسالة الجلسة الجديدة نمط Noise [NOISE]_ ذو الاتجاه الواحد
...
هذا هو المعيار لـ [NOISE]_ لـ IK معاسم بروتوكول معدلة.
