...
========================  ======  ===========  =================   =====================================
طلب تصويت                  1    المرشح      التابع              نداء بعيد Raft قياسي؛ لا يجب أن يحتوي على إدخالات السجل
استجابة طلب تصويت           2    التابع      المرشح              نداء بعيد Raft قياسي
طلب إدخال الإدخالات         3    القائد       التابع              نداء بعيد Raft قياسي
استجابة إدخال الإدخالات     4    التابع      القائد / العميل    نداء بعيد Raft قياسي
طلب العميل                  5    العميل       القائد / التابع    الاستجابة هي استجابة إدخال الإدخالات؛ يجب أن يحتوي فقط على إدخالات سجل التطبيق
طلب إضافة الخادم            6    العميل       القائد              يجب أن يحتوي على إدخال سجل خادم الكتلة واحد فقط
استجابة إضافة الخادم        7    القائد       العميل              سيرسل القائد أيضًا طلب الانضمام إلى الكتلة
طلب إزالة الخادم            8    التابع      القائد              يجب أن يحتوي على إدخال سجل خادم الكتلة واحد فقط
استجابة إزالة الخادم        9    القائد       التابع
طلب تزامن السجل             10    القائد       التابع              يجب أن يحتوي على إدخال سجل حزمة سجل واحد فقط
استجابة تزامن السجل         11    التابع      القائد
طلب الانضمام للكتلة         12    القائد       الخادم الجديد        دعوة للانضمام؛ يجب أن يحتوي على إدخال تكوين واحد فقط
استجابة الانضمام للكتلة     13    الخادم الجديد  القائد
طلب مغادرة الكتلة           14    القائد       التابع              أمر للمغادرة
استجابة مغادرة الكتلة       15    التابع       القائد
طلب تثبيت اللقطة            16    القائد       التابع              قسم 7 من Raft؛ يجب أن يحتوي على إدخال سجل طلب تزامن اللقطة واحد فقط
استجابة تثبيت اللقطة        17    التابع       القائد              قسم 7 من Raft
========================  ======  ===========  =================   =====================================
...
محتويات التطبيق تم ترميزها بـ UTF-8 [JSON]_.
...
محتويات التطبيق مرمزة بـ UTF-8 [JSON]_,
