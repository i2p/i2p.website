...
بدأنا بدراسة آثار تشفير PQ في عام 2022 [FORUM]_.

أضافت معايير TLS دعم التشفير الهجين في العامين الماضيين ويستخدم الآن لجزء كبير من حركة المرور المشفرة على الإنترنت بسبب الدعم في كروم وفايرفوكس [CLOUDFLARE]_.

مؤخراً، أكملت وتجذرت NIST ونشرت الخوارزميات الموصى بها للتشفير بعد الكم [NIST-PQ]_. تدعم الآن العديد من مكتبات التشفير الشائعة معايير NIST أو ستقوم بإصدار دعم في المستقبل القريب.

يوصى كل من [CLOUDFLARE]_ و [NIST-PQ]_ أن يبدأ الهجرة فوراً. انظر أيضاً إلى الأسئلة الشائعة لـ NSA PQ لعام 2022 [NSA-PQ]_. يجب أن يكون I2P رائداً في الأمن والتشفير. حان الوقت الآن لتنفيذ الخوارزميات الموصى بها. باستخدام نظام النوع المرن للتشفير والتوقيع، سوف نضيف أنواعًا للتشفير الهجين، ولتوقيعات PQ والهجين.
...
سندعم معايير NIST FIPS 203 و204 [FIPS203]_ [FIPS204]_
...
سنحدد الثلاثة متغيرات ML-KEM كما في [FIPS203]_,
...
سنحدد الثلاثة متغيرات ML-DSA كما في [FIPS204]_,
...
وليس المتغير "التقريري"، كما هو محدد في [FIPS204]_ القسم 3.4.
...
الهياكل المركبة وOIDs المحددة في [COMPOSITE-SIGS]_.
...
- ML-KEM (المعروفة سابقاً باسم CRYSTALS-Kyber) [FIPS203]_
- ML-DSA (المعروفة سابقاً باسم CRYSTALS-Dilithium) [FIPS204]_
...
تحديث الأقسام والجداول في وثيقة الهياكل المشتركة [COMMON]_ كما يلي:
...
================    ================= ======  =====
  النوع              طول المفتاح العام منذ   استخدام
================    ================= ======  =====
MLKEM512_X25519               32      0.9.xx  انظر الاقتراح 169، لمجموعات التأجير فقط، وليس لـ RIs أو المقاصد
MLKEM768_X25519               32      0.9.xx  انظر الاقتراح 169، لمجموعات التأجير فقط، وليس لـ RIs أو المقاصد
MLKEM1024_X25519              32      0.9.xx  انظر الاقتراح 169، لمجموعات التأجير فقط، وليس لـ RIs أو المقاصد
MLKEM512                     800      0.9.xx  انظر الاقتراح 169، للمصافحات فقط، وليس للمجموعات التأجيرية، أو RIs أو المقاصد
MLKEM768                    1184      0.9.xx  انظر الاقتراح 169، للمصافحات فقط، وليس للمجموعات التأجيرية، أو RIs أو المقاصد
MLKEM1024                   1568      0.9.xx  انظر الاقتراح 169، للمصافحات فقط، وليس للمجموعات التأجيرية، أو RIs أو المقاصد
MLKEM512_CT                  768      0.9.xx  انظر الاقتراح 169، للمصافحات فقط، وليس للمجموعات التأجيرية، أو RIs أو المقاصد
MLKEM768_CT                 1088      0.9.xx  انظر الاقتراح 169، للمصافحات فقط، وليس للمجموعات التأجيرية، أو RIs أو المقاصد
MLKEM1024_CT                1568      0.9.xx  انظر الاقتراح 169، للمصافحات فقط، وليس للمجموعات التأجيرية، أو RIs أو المقاصد
NONE                           0      0.9.xx  انظر الاقتراح 169، للمقاصد مع أنواع توقيع PQ فقط، وليس لـ RIs أو مجموعات التأجير
================    ================= ======  =====

المفاتيح العامة الهجينة هي المفاتيح X25519.
المفاتيح العامة لـ KEM هي المفتاح PQ المؤقت المرسل من أليس إلى بوب.
التشفير وترتيب البايتات محددة في [FIPS203]_.
...
================    ================== ======  =====
  النوع              طول المفتاح الخاص منذ   استخدام
================    ================== ======  =====
MLKEM512_X25519               32       0.9.xx  انظر الاقتراح 169، لاستخدامه فقط في مجموعات التأجير، وليس لـ RIs أو المقاصد
MLKEM768_X25519               32       0.9.xx  انظر الاقتراح 169، لاستخدامه فقط في مجموعات التأجير، وليس لـ RIs أو المقاصد
MLKEM1024_X25519              32       0.9.xx  انظر الاقتراح 169، لاستخدامه فقط في مجموعات التأجير، وليس لـ RIs أو المقاصد
MLKEM512                    1632       0.9.xx  انظر الاقتراح 169، للاستخدام فقط في المصافحات، وليس لمجموعات التأجير، أو RIs أو المقاصد
MLKEM768                    2400       0.9.xx  انظر الاقتراح 169، للاستخدام فقط في المصافحات، وليس لمجموعات التأجير، أو RIs أو المقاصد
MLKEM1024                   3168       0.9.xx  انظر الاقتراح 169، للاستخدام فقط في المصافحات، وليس لمجموعات التأجير، أو RIs أو المقاصد
================    ================== ======  =====
...
فير KEM وترتيب البايتات محددة في [FIPS203]_.
...
MLDSA44ph                            1344      0.9.xx  فقط لملفات SU3، وليس للهياكل netdb
MLDSA65ph                            1984      0.9.xx  فقط لملفات SU3، وليس للهياكل netdb
MLDSA87ph                            2624      0.9.xx  فقط لملفات SU3، وليس للهياكل netdb
============================   ==============  ======  =====

المفاتيح العامة للتوقيع الهجين هي مفتاح Ed25519 يليه PQ، كما في [COMPOSITE-SIGS]_.
الترميز وترتيب البايتات محددة في [FIPS204]_.
...
المفاتيح الخاصة للتوقيع الهجين هي المفتاح Ed25519 يليه المفتاح PQ، كما في [COMPOSITE-SIGS]_.
التشفير وترتيب البايتات محددة في [FIPS204]_.
...
MLDSA44ph                            2484      0.9.xx  فقط لملفات SU3، وليس للهياكل netdb

 انظر الاقتراح 169
MLDSA65ph                            3373      0.9.xx  فقط لملفات SU3، وليس للهياكل netdb انظر الاقتراح 169
MLDSA87ph                            4691      0.9.xx  فقط لملفات SU3، وليس للهياكل netdb انظر الاقتراح 169
============================   ==============  ======  =====

التوقيعات الهجينة هي توقيع Ed25519 يليه توقيع PQ، كما في [COMPOSITE-SIGS]_.
...
============================  ===========  =======================  ======  =====
        النوع                  رمز النوع    طول المفتاح العام الإجمالي  منذ   استخدام
============================  ===========  =======================  ======  =====
MLDSA44                           12                 1312           0.9.xx  انظر الاقتراح 169
MLDSA65                           13                 1952           0.9.xx  انظر الاقتراح 169
MLDSA87                           14                 2592           0.9.xx  انظر الاقتراح 169
MLDSA44_EdDSA_SHA512_Ed25519      15                 1344           0.9.xx  انظر الاقتراح 169
MLDSA65_EdDSA_SHA512_Ed25519      16                 1984           0.9.xx  انظر الاقتراح 169
MLDSA87_EdDSA_SHA512_Ed25519      17                 2624           0.9.xx  انظر الاقتراح 169
...
================    ===========  ======================= ======  =====
  النوع              رمز النوع    طول المفتاح العام الإجمالي منذ   استخدام
================    ===========  ======================= ======  =====
MLKEM512_X25519          5                 32            0.9.xx  انظر الاقتراح 169، لمجموعات التأجير فقط، وليس لـ RIs أو المقاصد
MLKEM768_X25519          6                 32            0.9.xx  انظر الاقتراح 169، لمجموعات التأجير فقط، وليس لـ RIs أو المقاصد
MLKEM1024_X25519         7                 32            0.9.xx  انظر الاقتراح 169، لمجموعات التأجير فقط، وليس لـ RIs أو المقاصد
...
============================  ===========  =======================  ======  ======  =====
        النوع                  رمز النوع    طول المفتاح العام الإجمالي  رئيسي    زائد    الطول الكامل للمقصد
============================  ===========  =======================  ======  ======  =====
...
============================  ===========  =======================  ======  ======  =====
        النوع                  رمز النوع    طول المفتاح العام الإجمالي  رئيسي    زائد    الطول الكامل لهوية الراوتر
============================  ===========  =======================  ======  ======  =====
...
قم بتحديث مواصفة ECIES-Ratchet [ECIES]_ كما يلي:
...
================    =========  =====  =========  =============  =============  ==========  =======
  النوع              نوع الكود  X len  Msg 1 len  Msg 1 Enc len  Msg 1 Dec len  PQ key len  pl len
================    =========  =====  =========  =============  =============  ==========  =======
...
================    =========  =====  =========  =============  =============  ==========  =======
  النوع              نوع الكود  Y len  Msg 2 len  Msg 2 Enc len  Msg 2 Dec len  PQ CT len   opt len
================    =========  =====  =========  =============  =============  ==========  =======
...
لا يتطلب مواصفات الراشيت [ECIES]_ ذلك، لذا فإن الحد الأدنى لحجم الحمولة هو 0.
...
قم بتحديث مواصفة NTCP2 [NTCP2]_ كما يلي:
...
================    =========  =====  =========  =============  =============  ==========  =======
  النوع              نوع الكود  X len  Msg 1 len  Msg 1 Enc len  Msg 1 Dec len  PQ key len  opt len
================    =========  =====  =========  =============  =============  ==========  =======
...
قم بتحديث مواصفة SSU2 [SSU2]_ كما يلي:
...
================    =========  =====  =========  =============  =============  ==========  =======
  النوع              نوع الكود  Y len  Msg 2 len  Msg 2 Enc len  Msg 2 Dec len  PQ CT len   pl len
================    =========  =====  =========  =============  =============  ==========  =======
X25519                   4       32     80+pl        16+pl             pl         --         pl
