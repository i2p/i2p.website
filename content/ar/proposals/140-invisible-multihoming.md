...
هذا التصميم متوافق تمامًا مع الشبكة، لأنه لا توجد تغييرات في تنسيق [LeaseSet]_. يجب أن تكون جميع أجهزة التوجيه على دراية بالبروتوكول الجديد، لكن هذا ليس مصدر قلق حيث سيتم التحكم بها جميعاً من نفس الكيان.


## ملاحظات الأداء والتوسعية

الحد الأقصى البالغ 16 [Leases] لكل LeaseSet لم يتغير بسبب هذا الاقتراح. بالنسبة للوجهات التي تتطلب المزيد من الأنفاق أكثر من هذا، هناك تعديلان محتملان للشبكة:
