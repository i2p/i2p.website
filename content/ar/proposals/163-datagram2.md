...
خرجت من [Prop123]_ كتقديم منفصل.
...
ليتم إضافته إلى مواصفات [DATAGRAMS]_.
...
- إضافة منع الإعادة للمخططات، كما تم في [Prop164]_ للبث.
- إضافة قسم للخيارات التعسفية
- إعادة استخدام تنسيق التوقيع غير المتصل من [Common]_ و[Streaming]_.
...
أضفه كـ PROTO_DATAGRAM2 إلى [I2CP]_.
...
أضف Datagram2 إلى [DATAGRAMS]_ على النحو التالي:
...
ملاحظة: تنسيق التوقيع غير المتصل هو نفسه في مواصفات الهياكل المشتركة [Common]_ و[Streaming]_.
...
أضف Datagram3 إلى [DATAGRAMS]_ كما يلي:
...
- الطول العملي محدود بالطبقات الأدنى من البروتوكولات - مواصفات رسالة النفق [TUNMSG]_ تحدد الرسائل بحوالي 61.2 كيلوبايت والوسائط الناقلة [TRANSPORT]_ تحد الرسائل حاليًا بحوالي 64 كيلوبايت، لذا فإن طول البيانات هنا
  محدود بحوالي 61 كيلوبايت.
- انظر الملاحظات الهامة حول موثوقية المخططات الكبيرة [API]_. للحصول
...
الإعلانات عبر بروتوكول UDP في تورنت [Prop160]_: قم بتصميمها من البداية.
