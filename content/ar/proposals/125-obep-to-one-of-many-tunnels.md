...
الأقران الوحيدون الذين يحتاجون لفهم المواصفات الجديدة هم OBGWs و OBEPs. يمكننا بالتالي جعل هذا التغيير متوافقًا مع الشبكة الحالية بجعل استخدامه مشروطاً بـ إصدار I2P المستهدف [VERSIONS](/en/docs/specs/i2np/#protocol-versions)
