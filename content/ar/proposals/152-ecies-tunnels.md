...
اطلع على [SPEC](/docs/specs/implementation/) للحصول على المواصفات الرسمية.

## النظرة العامة

يقترح هذا المستند تغييرات في تشفير رسائل بناء الأنفاق باستخدام البدائل التشفيرية المقدمة بواسطة [ECIES-X25519](/docs/specs/ecies/).
إنه جزء من الاقتراح العام [Prop156](/proposals/156-ecies-routers/) لتحويل أجهزة التوجيه من مفاتيح ElGamal إلى مفاتيح ECIES-X25519.
...
للحصول على نظرة عامة على جميع التغييرات المطلوبة لأجهزة التوجيه ECIES، انظر الاقتراح 156 [Prop156](/proposals/156-ecies-routers/).

يحافظ هذا الاقتراح على نفس حجم سجلات بناء الأنفاق،
حسب ما هو مطلوب للتوافق. سيتم تنفيذ سجلات ورسائل بناء أصغر لاحقًا - انظر [Prop157](/proposals/157-new-tbm/).

### البدائل التشفيرية

لا يتم تقديم أي بدائل تشفير جديدة. البدائل المطلوبة لتنفيذ هذا الاقتراح:

- AES-256-CBC كما في [Cryptography](/docs/specs/cryptography/)
- دوال STREAM ChaCha20/Poly1305:
  ENCRYPT(k, n, plaintext, ad) وDECRYPT(k, n, ciphertext, ad) - كما في [NTCP2](/docs/specs/ntcp2/) و[ECIES-X25519](/docs/specs/ecies/) و[RFC-7539](https://tools.ietf.org/html/rfc7539)
...
- لا تغيير في تشفير الطبقة AES للنفق، لذلك راجع [Prop153](/proposals/153-chacha20-layer-encryption/)
...
- الأنفاق ثنائية الاتجاه - لذلك راجع [Prop119](/proposals/119-bidirectional-tunnels/)
- تقليل عدد الرسائل البناء النفق - لذلك راجع [Prop157](/proposals/157-new-tbm/)
...
- وظيفة تشفير: ChaChaPoly
  ...
  مطابقة لمتطلبات [NTCP2](/docs/specs/ntcp2/).
...
وهذا مطابق أيضًا للرسالة الأولى (طلب الجلسة) في النمط XK المستخدم في [NTCP2](/docs/specs/ntcp2/).
...
يشمل التشفير غير المتماثل لسجلات الطلبات حاليًا ElGamal كما هو معرف في [Cryptography](/docs/specs/cryptography/)
...
للمراجعة، هذا هو المواصفات الحالية لـ tunnel BuildRequestRecord لأجهزة توجيه ElGamal، مأخوذ من [I2NP](/docs/specs/i2np/).
يتم إضافة بايت غير صفري وهش البيانات (SHA-256) إلى البيانات غير المشفرة قبل التشفير،
كما هو معرف في [Cryptography](/docs/specs/cryptography/).
...
حقل الأعلام هو نفس ما تم تعريفه في [Tunnel-Creation](/docs/specs/tunnel-creation/) ويحتوي على:
...
خيارات بناء النفق هي بنية Mapping كما هو معرف في [Common](/docs/specs/common-structures/).
...
خيارات الرد لبناء النفق هي بنية Mapping كما هو معرف في [Common](/docs/specs/common-structures/).
هذا للاستخدام المستقبلي. لا توجد خيارات معرفة حاليًا.
...
كما هو معرف في [Tunnel-Creation](/docs/specs/tunnel-creation/) لتجنب البصمة:
...
اطلع على [Prop156](/proposals/156-ecies-routers/) للحصول على تفاصيل مفاتيح التوجيه الثابتة لـ ECIES.
...
المخطط الذي تم تعريفه في [Tunnel-Creation](/docs/specs/tunnel-creation/). سيستخدم منشئو الأنفاق ECIES المخطط أعلاه للتشفير
إلى نقاط ECIES.
...
كما هو معرف في [Tunnel-Creation](/docs/specs/tunnel-creation/).
...
راجع [Prop156](/proposals/156-ecies-routers/).
