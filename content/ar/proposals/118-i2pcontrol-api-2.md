...
"id"
  ...
  يُستخدم لتحديد أي رد تم توليده بواسطة أي طلب.
...
"auth_token"
  ...
  يلزم تقديمه مع كل RPC باستثناء استدعاء `'authenticate'`.

"method_parameter_value"
  معلمة الطريقة.

  يُستخدم لتقديم نكهات مختلفة لطريقة. مثل 'get'، 'set' والأنواع
  المشابهة لذلك.

"result_value"
  القيمة التي تعيدها RPC. نوعها ومحتوياتها تعتمد على الطريقة
  وأي طريقة.
