...
يتضمن البرنامج الأساسي (Java) موجهًا يقدم ويحافظ على اتصال مع الشبكة. كما يوفر التطبيقات وخيارات التكوين لتخصيص تجربتك وسير العمل. تعرف على المزيد في [الوثائق](/en/docs/) الخاصة بنا.
