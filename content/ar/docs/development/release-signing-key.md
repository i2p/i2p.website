---
title: "مفتاح توقيع الإصدار"
description: "مفاتيح PGP المستخدمة لتوقيع إصدارات I2P وأين يمكن الحصول عليها"
...
<p> الإصدارات 0.9.57 وما بعدها موقعة بواسطة idk. مفتاحه العام الحالي هو: </p> <p> <a href="/idk.key.asc" >تحميل المفتاح العام PGP</a> </p><p>

<p> الإصدارات 0.7.6 و 0.9.56 موقعة من قبل zzz. مفتاحه العام الحالي هو: </p> <p> <a href="/zzz.key.asc" >تحميل المفتاح العام PGP</a> </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1

لقد أنشأت مفاتيح GPG جديدة ومفاتيح فرعية ووقعت المفاتيح الجديدة بالمفتاح القديم.
...
سأستخدم المفاتيح الجديدة كما يلي:
...
سيتم استخدام مفتاح التوقيع الخاص بالإصدار بدءًا من الإصدار 0.9.13. هذه الرسالة موقعة بمفتاحي القديم.
...
<p> الإصدارات من 0.9.9 يمكن أن تكون موقعة من قبل str4d. مفتاحه العام الحالي هو: </p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA512
...
أقوم بإنشاء مفاتيح فرعية جديدة للتشفير والتوقيع سنوياً. أي إصدار من I2P موقّع من قبلي سيكون دائماً موقعاً بأحدث مفتاح فرعي للتوقيع في وقت الإصدار.
...
<p> str4d وقّع على الإصدارات التالية: </p> <ul> <li>0.9.23</li> </ul>

<p> الإصدارات من 0.7.6 إلى 0.9.12 تم توقيعها بواسطة zzz باستخدام المفتاح التالي: </p> <p> <pre> -----BEGIN PGP PUBLIC KEY BLOCK----- Version: GnuPG v1.4.6 (GNU/Linux)
...
</pre> <p> الإصدارات من 0.6.1.31 إلى 0.7.5 تم توقيعها بواسطة Complication. مفتاحه العام هو: </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1
...
بالنسبة للأشخاص الذين يرغبون في نسخ المفتاح مباشرة من هذه الرسالة، ولكنهم لا يقرؤون هذا باستخدام برنامج بريد إلكتروني، يرجى تذكر حذف تسلسلات الهروب "- " من علامة البداية والنهاية لكتلة المفتاح العام. وإلا فلن يتم التعرف عليه.

تعقيد.

- -----BEGIN PGP PUBLIC KEY BLOCK-----

الإصدار: GnuPG v1.4.7 (GNU/Linux)
