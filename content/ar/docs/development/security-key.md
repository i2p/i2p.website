---
title: "مفتاح GPG الأمني"
description: "مفتاح GPG العام للاتصال بفريق أمن I2P"
slug: "security-key"
lastUpdated: "2025-10"
accurateFor: "2.10.0"
type: docs
...
للإبلاغ عن ثغرات أمنية أو مشكلات أمنية حساسة، يرجى الاتصال بفريق الأمان في I2P على **security@i2p.net**

للاتصال الآمن، يرجى استخدام مفتاح PGP الخاص بنا أدناه.

## معلومات مفتاح PGP

- **البريد الإلكتروني**: security@i2p.net
- **معرف المفتاح**: `176E1941`
- **البصمة**: `EA27 06D6 14F5 28DB 764B  F47E CFCD C461 75E6 694A`
- **نوع المفتاح**: RSA 4096-bit
- **تاريخ الإنشاء**: 2025-10-19
- **تاريخ انتهاء الصلاحية**: 2030-11-19
- **معرف المستخدم**: I2P Security &lt;security@i2p.net&gt;

## المفتاح العام

فيما يلي مفتاح GPG العام لفريق أمان I2P: <p> <pre> -----BEGIN PGP PUBLIC KEY BLOCK-----
