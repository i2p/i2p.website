...
date: 2021-05-17
author: "zzz"
description: "0.9.50 مع إصلاحات IPv6"
categories: ["release"]
---

## تفاصيل التحديث

تستمر النسخة 0.9.50 في الانتقال إلى ECIES-X25519 لمفاتيح تشفير الـrouter. قمنا بتمكين DNS عبر HTTPS لعملية إعادة البذر لحماية المستخدمين من التنصت السلبي على DNS. هناك العديد من الإصلاحات والتحسينات لعناوين IPv6، بما في ذلك دعم UPnP جديد.

أخيراً أصلحنا بعض أخطاء فساد البيانات المزمنة في SusiMail.
...
لقد حسّنّا دفاعاتنا ضد routers محتملة الخبث أو مليئة بالأخطاء في الشبكة.
...
[القائمة الكاملة للأخطاء التي تم إصلاحها](http://trac.i2p2.i2p/query?resolution=fixed&milestone=0.9.50)
