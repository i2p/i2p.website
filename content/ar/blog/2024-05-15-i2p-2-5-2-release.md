...
date: 2024-05-15
author: "zzz"
description: "الإصدار 2.5.2 مع إصلاح HTTP"
categories: ["release"]
---

تم إصدار I2P 2.5.2 لإصلاح خلل تم إدخاله في 2.5.0 وكان يتسبب في اقتطاع بعض محتوى HTTP.
...
[القائمة الكاملة بالأخطاء التي تم إصلاحها](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.5.2)
