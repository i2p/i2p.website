...
A few months ago we released both I2P Android and Bote on Google Play in Norway, to test the release process there. We are pleased to announce that both apps are now being released globally by [Privacy Solutions](https://privacysolutions.no/). The apps can be found at these URLs:
...
Don't think we have forgotten about you, F-Droid users! In addition to the two locations above, we have set up our own F-Droid repository. If you are reading this post on your phone, [click here](https://f-droid.i2p.io/repo?fingerprint=68E76561AAF3F53DD53BA7C03D795213D0CA1772C3FAC0159B50A5AA85C45DC6) to add it to F-Droid (this only works in some Android browsers). Or, you can manually add the URL below to your F-Droid repository list:
