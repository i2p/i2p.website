...
आधिकारिक विनिर्देश के लिए [SPEC]_ देखें।


## अवलोकन

यह दस्तावेज़ [ECIES-X25519]_ द्वारा पेश किए गए क्रिप्टो प्रिमिटिव का उपयोग करके सुरंग निर्माण संदेश एन्क्रिप्शन में बदलाव का प्रस्ताव करता है।
यह ElGamal से ECIES-X25519 कुंजी में राउटर को बदलने के लिए समग्र प्रस्ताव [Prop156]_ का एक हिस्सा है।
...
ECIES राउटर के लिए आवश्यक सभी परिवर्तनों का अवलोकन करने के लिए, प्रस्ताव 156 [Prop156]_ देखें।

यह प्रस्ताव संगतता के लिए सुरंग निर्माण रिकॉर्ड का समान आकार बनाए रखता है।
छोटे निर्माण रिकॉर्ड और संदेश बाद में लागू किए जाएंगे - [Prop157]_ देखें।
...
- [Cryptography]_ में जैसा AES-256-CBC
- STREAM ChaCha20/Poly1305 फंक्शंस:
  ENCRYPT(k, n, plaintext, ad) और DECRYPT(k, n, ciphertext, ad) - [NTCP2]_ [ECIES-X25519]_ और [RFC-7539]_ में जैसा
- X25519 DH फंक्शंस - [NTCP2]_ और [ECIES-X25519]_ में जैसा
- HKDF(salt, ikm, info, n) - [NTCP2]_ और [ECIES-X25519]_ में जैसा

अन्य Noise फंक्शंस जो अन्यत्र परिभाषित हैं:

- MixHash(d) - [NTCP2]_ और [ECIES-X25519]_ में जैसा
- MixKey(d) - [NTCP2]_ और [ECIES-X25519]_ में जैसा
...
- सुरंग AES "परत" एन्क्रिप्शन में कोई बदलाव नहीं, इसके लिए [Prop153]_ देखें
...
- [Prop143]_ में परिभाषित सुरंग निर्माण विकल्प का उपयोग, केवल छोटे संदेशों के लिए आवश्यक
- द्विदिश सुरंग - इसके लिए [Prop119]_ देखें
- छोटे सुरंग निर्माण संदेश - इसके लिए [Prop157]_ देखें
...
यह प्रस्ताव शोर प्रोटोकॉल फ्रेमवर्क [NOISE]_ (संशोधन 34, 2018-07-11) के आधार पर आवश्यकताओं को प्रदान करता है।
...
- DH फंक्शन: X25519
  X25519 DH 32 बाइट्स की कुंजी लंबाई के साथ जैसा [RFC-7748]_ में निर्दिष्ट है।

- साइफर फंक्शन: ChaChaPoly
  AEAD_CHACHA20_POLY1305 जैसा [RFC-7539]_ के खंड 2.8 में निर्दिष्ट है।
...
यह [NTCP2]_ में उपयोग किए गए XK पैटर्न के पहले (सत्र अनुरोध) संदेश के बराबर भी है।
...
अनुरोध रिकॉर्ड्स का यह विषम एन्क्रिप्शन वर्तमान में [क्रिप्टोग्राफी]_ में परिभाषित ElGamal है
...
संदर्भ के लिए, यह [I2NP]_ से लिए गए ElGamal राउटरों के लिए सुरंग निर्माण अनुरोध रिकॉर्ड का वर्तमान विनिर्देश है।
असंप्रेषित डेटा को एक गैर-शून्य बाइट और डेटा के SHA-256 हैश के साथ प्रिपेंड किया जाता है 
एन्क्रिप्शन से पहले, जैसा कि [क्रिप्टोग्राफी]_ में परिभाषित है।
...
ध्वज फ़ील्ड [Tunnel-Creation]_ में परिभाषित के रूप में वही है और इसमें निम्नलिखित शामिल हैं::
...
सुरंग निर्माण विकल्प [Common]_ में परिभाषित के रूप में एक मैपिंग संरचना है।
...
सुरंग निर्माण उत्तर विकल्प [Common]_ में परिभाषित के जैसे एक मैपिंग संरचना है।
यह भविष्य के उपयोग के लिए है। वर्तमान में कोई विकल्प परिभाषित नहीं हैं।
यदि मैपिंग संरचना खाली है, तो यह दो बाइट्स 0x00 0x00 है।
...
[Tunnel-Creation]_ में वर्णित है ताकि फिंगरप्रिंटिंग से बचा जा सके:
...
उत्तर पथ पर, अंतिम बिंदु (प्रेषक) को [Multiple-Encryption]_ को पूर्ववर्ती करना होगा, प्रत्येक हॉप के उत्तर कुंजी का उपयोग करके।
...
राउटर स्थिर ECIES कुंजियों के विवरण के लिए [Prop156]_ देखें।
...
यह "N" पैटर्न के साथ मानक [NOISE]_ है जिसमें मानक प्रोटोकॉल नाम है।
...
[Tunnel-Creation]_ में परिभाषित योजना का उपयोग करेंगे।
...
जैसा [Tunnel-Creation]_ में परिभाषित है।
