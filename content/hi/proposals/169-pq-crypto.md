...
निम्नलिखित के अनुसार common structures दस्तावेज़ [/en/docs/spec/common-structures/](/en/docs/spec/common-structures/) में अनुभागों और तालिकाओं को अपडेट करें:
...
ECIES-Ratchet specification [/en/docs/spec/ecies/](/en/docs/spec/ecies/) को निम्नलिखित के अनुसार अपडेट करें:
...
ध्यान दें कि जबकि message 2 में सामान्यतः एक nonzero payload होगा, ratchet specification [/en/docs/spec/ecies/](/en/docs/spec/ecies/) इसकी आवश्यकता नहीं करता, इसलिए न्यूनतम payload size 0 है। न्यूनतम message 2 sizes की तदनुसार गणना की जा सकती है।

### हस्ताक्षर

NTCP2 specification [/en/docs/spec/ntcp2/](/en/docs/spec/ntcp2/) को निम्नलिखित के अनुसार अपडेट करें:
...
SSU2 specification [/en/docs/spec/ssu2/](/en/docs/spec/ssu2/) को निम्नलिखित के अनुसार अपडेट करें:
