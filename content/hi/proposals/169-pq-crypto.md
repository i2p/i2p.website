...
हमने 2022 में PQ क्रिप्टो के प्रभावों की जांच शुरू की [FORUM]_।

TLS मानकों ने पिछले दो वर्षों में हाइब्रिड एन्क्रिप्शन समर्थन जोड़ा है और अब यह इंटरनेट पर एन्क्रिप्टेड ट्रैफिक के एक महत्वपूर्ण हिस्से के लिए उपयोग किया जाता है, क्योंकि Chrome और Firefox में समर्थन है [CLOUDFLARE]_।

NIST ने हाल ही में पोस्ट-क्वांटम क्रिप्टोग्राफी के लिए अनुशंसित एल्गोरिदम को अंतिम रूप दिया और प्रकाशित किया [NIST-PQ]_।
कई सामान्य क्रिप्टोग्राफी लाइब्रेरी अब NIST मानकों का समर्थन करती हैं या निकट भविष्य में समर्थन जारी करेंगी।

दोनों [CLOUDFLARE]_ और [NIST-PQ]_ ने सुझाव दिया है कि माइग्रेशन तुरंत शुरू होना चाहिए।
देखें 2022 NSA PQ FAQ [NSA-PQ]_।
...
==================================  ======
हाइब्रिड MLKEM Ratchet और LS       स्वीकृत 2026-06; बीटा लक्ष्य 2025-08; रिलीज़ लक्ष्य 2025-11
हाइब्रिड MLKEM NTCP2               कुछ विवरणों को अंतिम रूप दिया जाना बाकी
हाइब्रिड MLKEM SSU2                कुछ विवरणों को अंतिम रूप दिया जाना बाकी
MLDSA SigTypes 12-14               प्रस्ताव स्थिर है लेकिन 2026 तक अंतिम रूप नहीं दिया जा सकता
MLDSA Dests                        लाइव नेट पर परीक्षण किया गया, फ्लडफ़िल समर्थन के लिए नेट अपग्रेड की आवश्यकता
हाइब्रिड SigTypes 15-17           प्रारंभिक
हाइब्रिड डेस्ट्स
==================================  ======
...
हम NIST FIPS 203 और 204 मानकों का समर्थन करेंगे [FIPS203]_ [FIPS204]_
...
=======  ==========  ================  ===============
प्रोटो    नोइस प्रकार  PQ-केवल समर्थन?  हाइब्रिड समर्थन?
=======  ==========  ================  ===============
NTCP2       XK       नहीं              हाँ
SSU2        XK       नहीं              हाँ
Ratchet     IK       नहीं              हाँ
...
हम [FIPS203]_ में तीन ML-KEM वेरिएंट को परिभाषित करेंगे,
...
==========================  ================  ===============
प्रकार                        PQ-केवल समर्थन?  हाइब्रिड समर्थन?
==========================  ================  ===============
RouterInfo                  हाँ               हाँ
LeaseSet                    हाँ               हाँ
Streaming SYN/SYNACK/Close  हाँ               हाँ
Repliable Datagrams         हाँ               हाँ
Datagram2 (प्रस्ताव 163)   हाँ               हाँ
...
हम [FIPS204]_ के अनुसार तीन ML-DSA वेरिएंट परिभाषित करेंगे,
...
"डिटरमिनस्टिक" वेरिएंट नहीं, जैसा [FIPS204]_ अनुभाग 3.4 में परिभाषित किया गया है।
...
X.509 प्रमाणपत्र और अन्य DER एन्कोडिंग [COMPOSITE-SIGS]_ में परिभाषित संरचनाओं और OIDs का उपयोग करेंगे।
...
- ML-KEM (पूर्व में CRYSTALS-Kyber) [FIPS203]_
- ML-DSA (पूर्व में CRYSTALS-Dilithium) [FIPS204]_
...
सामान्य संरचनाओं के दस्तावेज़ में अनुभाग और तालिकाएँ निम्नानुसार अद्यतन करें [COMMON]_:
...
================    ================= ======  =====
  प्रकार              सार्वजनिक कुंजी लंबाई तब से   उपयोग
================    ================= ======  =====
MLKEM512_X25519               32      0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM768_X25519               32      0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM1024_X25519              32      0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM512                     800      0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM768                    1184      0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM1024                   1568      0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM512_CT                  768      0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM768_CT                 1088      0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM1024_CT                1568      0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
NONE                           0      0.9.xx  प्रस्ताव 169 देखें, केवल PQ हस्ताक्षर प्रकारों के साथ डेस्टिनेशन्स के लिए, RIs या लीसेसेट्स के लिए नहीं
================    ================= ======  =====

हाइब्रिड सार्वजनिक कुंजियाँ X25519 कुंजी हैं।
KEM सार्वजनिक कुंजियाँ अस्थायी PQ कुंजी हैं जो एलीस से बॉब को भेजी जाती हैं।
एन्कोडिंग और बाइट क्रम [FIPS203]_ में परिभाषित हैं।
...
MLKEM768_X25519               32       0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM1024_X25519              32       0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM512                    1632       0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM768                    2400       0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM1024                   3168       0.9.xx  प्रस्ताव 169 देखें, केवल हैंडशेक के लिए, लीसेसेट्स, RIs या डेस्टिनेशन्स के लिए नहीं
================    ================== ======  =====

हाइब्रिड निजी कुंजियाँ X25519 कुंजियाँ होती हैं।
KEM निजी कुंजियाँ केवल एलीस के लिए होती हैं।
KEM एन्कोडिंग और बाइट क्रम [FIPS203]_ में परिभाषित हैं।
...
MLDSA44ph                            1344      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं
MLDSA65ph                            1984      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं
MLDSA87ph                            2624      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं
============================   ==============  ======  =====

हाइब्रिड साइनिंग सार्वजनिक कुंजियाँ [COMPOSITE-SIGS]_ के अनुसार Ed25519 कुंजी और PQ कुंजी होती हैं।
एन्कोडिंग और बाइट क्रम [FIPS204]_ में परिभाषित हैं।
...
MLDSA44ph                            2592      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं देखें प्रस्ताव 169
MLDSA65ph                            4064      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं देखें प्रस्ताव 169
MLDSA87ph                            4928      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं देखें प्रस्ताव 169
============================   ==============  ======  =====

हाइब्रिड साइनिंग प्राइवेट कुंजियाँ [COMPOSITE-SIGS]_ के अनुसार Ed25519 कुंजी और PQ कुंजी होती हैं।
एन्कोडिंग और बाइट क्रम [FIPS204]_ में परिभाषित हैं।
...
MLDSA44ph                            2484      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं देखें प्रस्ताव 169
MLDSA65ph                            3373      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं देखें प्रस्ताव 169
MLDSA87ph                            4691      0.9.xx  केवल SU3 फाइलों के लिए, नेटदब संरचनाओं के लिए नहीं देखें प्रस्ताव 169
============================   ==============  ======  =====

हाइब्रिड हस्ताक्षर [COMPOSITE-SIGS]_ के अनुसार Ed25519 हस्ताक्षर और PQ हस्ताक्षर होते हैं।
...
================    ===========  ======================= ======  =====
  प्रकार              प्रकार कोड    कुल सार्वजनिक कुंजी लंबाई तब से   उपयोग
================    ===========  ======================= ======  =====
MLKEM512_X25519          5                 32            0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM768_X25519          6                 32            0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
MLKEM1024_X25519         7                 32            0.9.xx  प्रस्ताव 169 देखें, केवल लीसेसेट्स के लिए, RIs या डेस्टिनेशन्स के लिए नहीं
...
============================  ===========  =======================  ======  ======  =====
        प्रकार                  प्रकार कोड    कुल सार्वजनिक कुंजी लंबाई  मुख्य    अतिरिक्त  कुल डेस्ट लंबाई
============================  ===========  =======================  ======  ======  =====
...
============================  ===========  =======================  ======  ======  =====
        प्रकार                  प्रकार कोड    कुल सार्वजनिक कुंजी लंबाई  मुख्य    अतिरिक्त  कुल राउटर पहचान लंबाई
============================  ===========  =======================  ======  ======  =====
...
ECIES-Ratchet विनिर्देश [ECIES]_ को निम्नानुसार अद्यतन करें:
...
================    =========  =====  =========  =============  =============  ==========  =======
  प्रकार              प्रकार कोड  X लंबाई  Msg 1 लंबाई  Msg 1 एन्क लंबाई  Msg 1 डेक लंबाई  PQ कुंजी लंबाई  pl लंबाई
================    =========  =====  =========  =============  =============  ==========  =======
...
================    =========  =====  =========  =============  =============  ==========  =======
  प्रकार              प्रकार कोड  Y लंबाई  Msg 2 लंबाई  Msg 2 एन्क लंबाई  Msg 2 डेक लंबाई  PQ CT लंबाई   ऑप्ट लंबाई
================    =========  =====  =========  =============  =============  ==========  =======
...
रैचेट विनिर्देश [ECIES]_ इसे आवश्यक नहीं मानता, इसलिए न्यूनतम पेलोड आकार 0 है।
न्यूनतम संदेश 2 आकार के अनुसार गणना की जा सकती है।

### NTCP2

NTCP2 विनिर्देश [NTCP2]_ को निम्नानुसार अद्यतन करें:
...
================    =========  =====  =========  =============  =============  ==========  =======
  प्रकार              प्रकार कोड  X लंबाई  Msg 1 लंबाई  Msg 1 एन्क लंबाई  Msg 1 डेक लंबाई  PQ कुंजी लंबाई  ऑप्ट लंबाई
================    =========  =====  =========  =============  =============  ==========  =======
...
SSU2 विनिर्देश [SSU2]_ को निम्नानुसार अद्यतन करें:
