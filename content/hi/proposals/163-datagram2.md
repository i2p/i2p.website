...
[Prop123]_ से एक अलग प्रस्ताव के रूप में खींचा गया।
...
इसके लिए एक पूरी तरह से नया I2CP प्रोटोकॉल नंबर और प्रारूप की आवश्यकता होगी, जिसे [DATAGRAMS]_ विशेषता में जोड़ा जाएगा। 
...
डाटाग्राम2 का उपयोग करने वाला पहला अनुप्रयोग बिटटोरेंट UDP घोषणाएं होने की उम्मीद है, जैसा कि i2psnark और zzzot में लागू किया गया है, देखें [Prop160]_।

## प्रत्युत्तर योग्य डाटाग्राम विशेषता

संदर्भ के लिए, नीचे प्रत्युत्तर योग्य डाटाग्राम्स के विशिष्ट अवलोकन की समीक्षा है, जो [Datagrams]_ से कॉपी की गई है। प्रत्युत्तर योग्य डाटाग्राम के लिए मानक I2CP प्रोटोकॉल संख्या PROTO_DATAGRAM (17) है।
...
- डाटाग्राम के लिए प्रत्युत्तरण रोकथाम जोड़ें, जैसा कि [Prop164]_ में स्ट्रीमिंग के लिए किया गया था।
- मनमाने विकल्पों के लिए सेक्शन जोड़ें
- ऑफलाइन हस्ताक्षर प्रारूप को [Common]_ और [Streaming]_ से पुनः उपयोग करें।
...
[I2CP]_ के तहत इसे PROTO_DATAGRAM2 के रूप में जोड़ें।
...
डाटाग्राम2 को [DATAGRAMS]_ में निम्नलिखित के रूप में जोड़ें:
...
नोट: ऑफलाइन हस्ताक्षर प्रारूप सामान्य संरचना विनिर्देश [Common]_ और [Streaming]_ के समान है।
...
डाटाग्राम3 को [DATAGRAMS]_ में निम्नलिखित के रूप में जोड़ें:
...
- व्यवहारिक लंबाई प्रोटोकॉल की निचली परतों द्वारा सीमित है - सुरंग
  संदेश विनिर्देश [TUNMSG]_ संदेशों को लगभग 61.2 KB तक सीमित करता है और परिवहन
  [TRANSPORT]_ वर्तमान में संदेशों को लगभग 64 KB तक सीमित करता है, इसलिए यहां डेटा लंबाई
  लगभग 61 KB तक सीमित है।
- बड़े डाटाग्राम्स की विश्वसनीयता के बारे में महत्वपूर्ण नोट्स देखें [API]_। 
...
बिटटोरेंट UDP घोषणाएं [Prop160]_ : डिज़ाइन में प्रारंभ में समाहित करें।
