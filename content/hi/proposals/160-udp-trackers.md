...
I2P में UDP ट्रैकर्स के लिए एक प्रारंभिक प्रस्ताव हमारे बिटटोरेंट स्पेक पेज [SPEC]_ पर मई 2014 में पोस्ट किया गया था; यह हमारे औपचारिक प्रस्ताव प्रक्रिया से पहले था, और इसे कभी लागू नहीं किया गया था। यह प्रस्ताव 2022 की शुरुआत में बनाया गया था और 2014 के संस्करण को सरल बनाता है।

चूंकि यह प्रस्ताव पुनरावलोकन योग्य डेटाग्राम्स पर निर्भर करता है, इसे होल्ड पर रखा गया जब हमने 2023 की शुरुआत में Datagram2 प्रस्ताव [Prop163]_ पर काम करना शुरू किया। वह प्रस्ताव अप्रैल 2025 में स्वीकृत हुआ।

2023 के इस प्रस्ताव ने दो मोड निर्दिष्ट किए, "अनुकूलता" और "तेज"। आगे के विश्लेषण से पता चला कि तेज मोड असुरक्षित होगा, और बड़ी संख्या में टोरेंट वाले क्लाइंट्स के लिए भी अक्षम होगा। आगे, BiglyBT ने अनुकूलता मोड के लिए वरीयता दिखाई। यह मोड किसी भी ट्रैकर या क्लाइंट के लिए मानक [BEP15]_ का समर्थन करने के लिए लागू करना आसान होगा।
...
इसलिए, यहां वर्तमान संस्करण को तेज़ मोड को हटाने के लिए और अधिक सरल बनाया गया है, और "अनुकूलता" शब्द को हटा दिया गया है। वर्तमान संस्करण नए Datagram2 प्रारूप पर स्विच करता है, और UDP घोषणा विस्तार प्रोटोकॉल [BEP41]_ के संदर्भ जोड़ता है।
...
बिटटोरेंट ने 2008 में BEP 15 [BEP15]_ में UDP ट्रैकर्स का प्रस्ताव दिया था, और अब अधिकांश ट्रैकर्स स्पष्ट नेटवर्क पर केवल UDP हैं।
...
पोस्ट-क्वांटम एन्क्रिप्शन और हस्ताक्षर जैसे कि [Prop169]_ में दर्शाया गया है एन्क्रिप्टेड और साइन किए गए संरचनाओं सहित गंतव्य, लीसेट्स, स्ट्रीमिंग SYN और SYN ACK के अधिशेष को काफी बढ़ाएंगे। यह महत्वपूर्ण है कि I2P में PQ क्रिप्टो के अपनाने से पहले यह अधिशेष जहां संभव हो सके, न्यूनतम करें।

## डिज़ाइन

यह प्रस्ताव पुनरावलोकनीय डेटाग्राम2, पुनरावलोकनीय डेटाग्राम3, और रॉ डेटाग्राम्स का उपयोग करता है, जैसा कि [DATAGRAMS]_ में परिभाषित है। डेटाग्राम2 और डेटाग्राम3 पुनरावलोकनीय डेटाग्राम्स के नए संस्करण हैं, प्रस्ताव 163 [Prop163]_ में परिभाषित हैं। डेटाग्राम2 पुनरावलोकन प्रतिरोध और ऑफ़लाइन हस्ताक्षर समर्थन जोड़ता है। डेटाग्राम3 पुरानी डेटाग्राम प्रारूप से छोटा है, लेकिन प्रामाणिकता के बिना।

### BEP 15

संदर्भ के लिए, [BEP15]_ में परिभाषित संदेश प्रवाह इस प्रकार है:
...
यह डिज़ाइन जितना संभव हो सके [BEP15]_ के साथ संगतता बनाए रखता है ताकि मौजूदा क्लाइंट्स और ट्रैकर्स में आवश्यक परिवर्तन कम किए जा सकें।
...
ऊष्मान URL प्रारूप [BEP15]_ में निर्दिष्ट नहीं है, लेकिन जैसा कि स्पष्ट नेटवर्क में, UDP ऊष्मान URLs "udp://host:port/path" के रूप में होते हैं। पथ को नजरअंदाज किया जा सकता है और यह खाली हो सकता है, लेकिन यह आमतौर पर स्पष्ट नेटवर्क में "/announce" होता है। :पोर्ट भाग हमेशा उपस्थित होना चाहिए, हालाँकि, अगर ":पोर्ट" भाग छोड़ा गया है, तो 6969 के डिफ़ॉल्ट I2C पोर्ट का उपयोग करें, क्योंकि यह स्पष्ट नेटवर्क पर आम पोर्ट है। cgi पैरामीटर &a=b&c=d भी जुड़े हो सकते हैं, उन्हें घोषणा अनुरोध में संसाधित और प्रदान किया जा सकता है, देखें [BEP41]_। अगर कोई पैरामीटर या पथ नहीं है, तो अंतिम / भी छोड़ा जा सकता है, जैसा कि [BEP41]_ में निहित है।
...
क्लाइंट से ट्रैकर तक। 16 बाइट्स। पुनरावलोकनीय Datagram2 होना चाहिए। [BEP15]_ के समान। कोई परिवर्तन नहीं।
...
ट्रैकर से क्लाइंट तक। 16 या 18 बाइट्स। रॉ होना चाहिए। [BEP15]_ के समान सिवाय जिनके नीचे बदलाव किए गए हैं।
...
क्लाइंट से ट्रैकर तक। न्यूनतम 98 बाइट्स। पुनरावलोकनीय Datagram3 होना चाहिए। [BEP15]_ के समान सिवाए जिनके नीचे बदलाव किए गए हैं।
...
- विकल्पों का खंड, अगर उपस्थित है, [BEP41]_ में निर्दिष्ट जैसा है
...
ट्रैकर से क्लाइंट तक। न्यूनतम 20 बाइट्स। रॉ होना चाहिए। [BEP15]_ के समान सिवाए जिनके नीचे बदलाव किए गए हैं।
...
Scrape अनुरोध/प्रतिक्रिया [BEP15]_ से नहीं आवश्यक है, लेकिन यदि वांछित लागू किया जा सकता है, कोई परिवर्तन की आवश्यकता नहीं। क्लाइंट को पहले एक कनेक्शन ID प्राप्त करना होगा। स्क्रेप अनुरोध हमेशा पुनरावलोकनीय Datagram3 होता है। स्क्रेप प्रतिक्रिया हमेशा रॉ होती है। 

Error Response
``````````````

ट्रैकर से क्लाइंट तक। 8 बाइट्स न्यूनतम (यदि संदेश खाली है)। रॉ होना चाहिए। [BEP15]_ का सामान। कोई परिवर्तन नहीं।
...
एक्सटेंशन बिट्स या एक संस्करण फील्ड शामिल नहीं हैं। क्लाइंट्स और ट्रैकर्स को फ़िक्स आकार के पैकेट्स की अपेक्षा नहीं करनी चाहिए। इस तरह, बिना संगतता तोड़े अतिरिक्त फ़ील्ड जोड़ी जा सकती हैं। यदि आवश्यक हो, [BEP41]_ में परिभाषित एक्सटेंशन प्रारूप अनुशंसित है।

कनेक्ट प्रतिक्रिया को वैकल्पिक कनेक्शन ID जीवनकाल जोड़ने के लिए संशोधित किया गया है।

अगर ब्लाइंडेड गंतव्य समर्थन की आवश्यकता होती है, हम घोषणा अनुरोध के अंत में ब्लाइंडेड 35-बाइट पता जोड़ सकते हैं, या प्रतिक्रिया में ब्लाइंडेड हैश का अनुरोध कर सकते हैं, [BEP41]_ प्रारूप का उपयोग कर (पैरामीटर TBD)।
