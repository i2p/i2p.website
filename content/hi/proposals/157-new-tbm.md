...
लघु संशोधन के अधीन।
अंतिम विनिर्देश के लिए [I2NP](/docs/specs/i2np/) और [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) देखें।
...
ECIES-X25519 राउटर के लिए 528-बाइट रिकॉर्ड प्रारूप में परिवर्तन [Prop152](/proposals/152-ecies-tunnels/) और [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) में निर्दिष्ट किए गए हैं।
...
अधिक लक्ष्यों के लिए [Prop152](/proposals/152-ecies-tunnels/) और [Prop156](/proposals/156-ecies-routers/) देखें।

- छोटे रिकॉर्ड और संदेश
- भविष्य के विकल्पों के लिए पर्याप्त जगह बनाए रखें, जैसा कि [Prop152](/proposals/152-ecies-tunnels/) और [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) में है
- उल्टी दिशा के लिए एक टनल संदेश में फिट हो
- केवल ECIES होप्स का समर्थन करें
- [Prop152](/proposals/152-ecies-tunnels/) और [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) में कार्यान्वित सुधारों का रखरखाव करें
...
अधिक गैर-लक्ष्यों के लिए [Prop156](/proposals/156-ecies-routers/) देखें।
...
और 464 बाइट्स ECIES रिकॉर्ड [Prop152](/proposals/152-ecies-tunnels/) और [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) के रूप में परिभाषित।

सादे टेक्स्ट प्रतिक्रिया रिकॉर्ड 202 बाइट्स होंगे,
496 बाइट्स ElGamal रिकॉर्ड के मुकाबले,
और 512 बाइट्स ECIES रिकॉर्ड [Prop152](/proposals/152-ecies-tunnels/) और [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) के रूप में परिभाषित।
...
अनुरोध और प्रतिक्रिया रिकॉर्ड एन्क्रिप्शन: जैसा कि [Prop152](/proposals/152-ecies-tunnels/) और [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) में परिभाषित है।
...
यह ECIES-X25519 राउटर्स के लिए टनल BuildRequestRecord के प्रस्तावित विनिर्देशन है। [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) से परिवर्तनों का सार:
...
फ्लैग्स फील्ड [टनेल-निर्माण](/docs/specs/implementation/#tunnel-creation-ecies) में परिभाषित के समान है और उसमें निम्नलिखित शामिल हैं::
...
टनल बिल्ड विकल्प एक मैपिंग संरचना है जैसा कि [कॉमन](/docs/specs/common-structures/) में परिभाषित है। 
...
यह ECIES-X25519 राउटर्स के लिए टनल ShortBuildReplyRecord के प्रस्तावित विनिर्देशन है। [टनल-निर्माण-ECIES](/docs/specs/implementation/#tunnel-creation-ecies) से परिवर्तनों का सार:
...
टनल बिल्ड प्रतिक्रिया विकल्प एक मैपिंग संरचना है जैसा कि [कॉमन](/docs/specs/common-structures/) में परिभाषित है। 
यह भविष्य के उपयोग के लिए है। कोई विकल्प वर्तमान में परिभाषित नहीं हैं।
यदि मैपिंग संरचना खाली है, तो यह दो बाइट्स 0x00 0x00 है।
...
[टनल-निर्माण](/docs/specs/implementation/#tunnel-creation-ecies) में परिभाषित करने के लिए उंगली पहचान से बचने के लिए:
