...
आधिकारिक विशिष्टता के लिए [SPEC]_ देखें।
...
सामान्य संरचनाओं की विशिष्टता देखें [Common]_।
...
[NOISE]_ के नॉइज़ "पे लोड सिक्योरिटी प्रॉपर्टीज" तालिका देखें।
...
मौजूदा I2P राउटर कार्यान्वयन जिन्होंने अभी तक [NTCP2]_ ([Prop111]_) लागू नहीं किया है,
...
क्रिप्टो प्रकार 1-3 ECIES-ECDH-AES-SessionTag के लिए आरक्षित हैं, प्रस्ताव 145 [Prop145]_ देखें।


### नॉइज़ प्रोटोकॉल फ्रेमवर्क

यह प्रस्ताव नॉइज़ प्रोटोकॉल फ्रेमवर्क [NOISE]_ (संशोधन 34, 2018-07-11) के आधार पर आवश्यकताओं को प्रदान करता है।
नॉइज़ की समान संपत्तियां स्टेशन-टू-स्टेशन प्रोटोकॉल [STS]_ के समान हैं,
जो [SSU]_ प्रोटोकॉल का आधार है। नॉइज़ की भाषा में, ऐलिस
...
- DH फ़ंक्शन: X25519
  X25519 DH 32 बाइट की कुंजी लंबाई के साथ [RFC-7748]_ में निर्दिष्ट के रूप में।

- सिफर फ़ंक्शन: ChaChaPoly
  AEAD_CHACHA20_POLY1305 [RFC-7539]_ धारा 2.8 में निर्दिष्ट के रूप में।
...
Noise_IK_25519_ChaChaPoly_SHA256. ये आमतौर पर [NOISE]_ धारा 13 में दिए गए निर्देशों का पालन करते हैं।

1) क्लीयरटेक्स्ट क्षणिक कुंजियों को [Elligator2]_ से कोडित किया गया है।
...
सभी संदेशों में [I2NP]_ गार्लिक संदेश हेडर शामिल होते हैं।
...
H(p, d)
    ...
    [NOISE]_ में परिभाषित किया गया है।
...
STREAM
    [RFC-7539]_ में निर्दिष्ट ChaCha20/Poly1305 AEAD।
...
HKDF(salt, ikm, info, n)
    ...
    [RFC-5869]_ में निर्दिष्ट HKDF का उपयोग करें, HMAC हैश फ़ंक्शन SHA-256
    [RFC-2104]_ में निर्दिष्ट के रूप में। इसका मतलब है कि SALT_LEN 32 बाइट मैक्स है।

MixKey(d)
    पिछले श्रृंखला कुंजी और नए डेटा d के साथ HKDF() का उपयोग करें, और
    नई श्रृंखला कुंजी और k सेट करता है।
    [NOISE]_ में परिभाषित के अनुसार।
...
[I2NP]_ में निर्दिष्ट गार्लिक संदेश इस प्रकार से है।
...
विवरण और पूर्ण विशिष्टता के लिए [I2NP]_ देखें।
...
नया सत्र संदेश एक-तरफा नॉइज़ [NOISE]_ पैटर्न
...
यह मानक [NOISE]_ है IK के लिए एक संशोधित प्रोटोकॉल नाम के साथ।
