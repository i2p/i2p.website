...
Destinations प्रत्येक स्ट्रीमिंग SYN [Streaming]_ और प्रतिफलित डेटाग्राम [Datagram]_ में शामिल होते हैं।
Router Infos (जिसमें Router Identities शामिल हैं) Database Store Messages [I2NP]_ में शामिल होती हैं
और [NTCP2]_ और [SSU2]_ में Session Confirmed संदेशों में शामिल होती हैं।
...
लेकिन यह Java I2P javadocs [PKF]_ में दस्तावेज किया गया है
...
### SAM
[SAM]_ में यह नोट करें कि एन्क्रिप्शन निजी कुंजी अप्रयुक्त है और इसे अनदेखा किया जा सकता है।
...
### I2CP
[I2CP]_ में कोई बदलाव आवश्यक नहीं है। गंतव्य में एन्क्रिप्शन सार्वजनिक कुंजी के लिए निजी कुंजी राउटर को नहीं भेजी जाती है।
...
Java I2P के लिए एक ड्राफ्ट मर्ज अनुरोध [MR]_ में है।
