...
- ElG: ElGamal
- ENCRYPT(k, n, payload, ad): जैसा कि [ECIES]_ में परिभाषित किया गया है
- LS: लीज़सेट
- लुकअप: I2NP DLM
...
[ECIES]_ गंतव्यों के साथ, प्रस्ताव 144 का उद्देश्य यह है कि गंतव्य अब 32-बाइट टैग और AES डिक्रिप्शन का समर्थन नहीं करेंगे। विशेषताएँ जानबूझकर उस प्रस्ताव में शामिल नहीं की गई थीं।
...
- नए DLM प्रारूप में ध्वज फ़ील्ड में एक बिट जोड़ें ताकि ECIES-एन्क्रिप्टेड उत्तरों को निर्दिष्ट किया जा सके। ECIES-एन्क्रिप्टेड उत्तर [ECIES]_ मौजूदा सत्र संदेश प्रारूप का उपयोग करेंगे, एक प्रीपेंड किए गए टैग और एक ChaCha/Poly पेलोड और MAC के साथ।
...
[I2NP]_ DLM (डेटाबेस लुकअप) विनिर्देश में, निम्नलिखित परिवर्तन करें।
...
उत्तर एक ECIES मौजूदा सत्र संदेश है, जैसा कि [ECIES]_ में परिभाषित है।
...
ECIES राउटर 0.9.48 में परिचय हुआ, देखें [Prop156](/en/proposals/156-ecies-routers/)।
0.9.49 के रूप में, ECIES गंतव्यों और राउटर एक ही प्रारूप का उपयोग कर सकते हैं जैसा कि "ECIES से ElG" अनुभाग में, उत्तर कुंजियों के साथ अनुरोध में शामिल होता है। लुकअप "एक बार का प्रारूप" का उपयोग करेगा [ECIES]_ में जैसा कि आवेदक गुमनाम है।
...
लुकअप "एक बार का प्रारूप" का उपयोग करेगा [ECIES]_ में जैसा कि आवेदक गुमनाम है।
...
उत्तर एक ECIES मौजूदा सत्र संदेश है, जैसा कि [ECIES]_ में परिभाषित है। सभी परिभाषाओं के लिए [ECIES]_ देखें।
...
// Alice के X25519 अस्थायी कुंजी
  ...
  tag :: 8 बाइट के रूप में RATCHET_TAG() में उत्पन्न हुआ [ECIES]_

  k :: 32 बाइट के रूप में RATCHET_KEY() में उत्पन्न हुआ [ECIES]_
...
जो [ECIES]_ में जैसा है, संदर्भ के लिए नीचे कॉपी किया गया है।
