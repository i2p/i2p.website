...
- ECIES राउटर्स 0.9.48 के तहत कार्यान्वित, देखें [Common]_।
- टनल निर्माण 0.9.48 के तहत कार्यान्वित, देखें [Tunnel-Creation-ECIES]_।
- ECIES राउटर्स को एन्क्रिप्टेड संदेश 0.9.49 के तहत कार्यान्वित, देखें [ECIES-ROUTERS]_।
...
LS2 [Prop123]_ और ECIES-X25519-AEAD-Ratchet [Prop144]_ (अब [ECIES]_ में निर्दिष्ट) के लिए प्रस्ताव
...
अधिक लक्ष्य के लिए [Prop152]_ देखें।
...
अतिरिक्त गैर-लक्ष्यों के लिए [Prop152]_ देखें।

- दोहरे-कुंजी राउटरों की आवश्यकता नहीं
- लेयर एन्क्रिप्शन परिवर्तन, इसके लिए [Prop153]_ देखें
...
राउटर के लिए इसकी कोई आवश्यकता नहीं है। राउटर की एन्क्रिप्शन कुंजी इसकी राउटर पहचान में है। साझा संरचना विशिष्टता देखें [Common]_।
...
यह साझा संरचनाओं के निर्दिष्ट मानक निर्माण के समान है [Common]_।

यह प्रस्ताव 145 [Prop145]_ में प्रस्तावित ECIES-P256 के लिए क्रिप्टो प्रकार 1-3 के लिए समान है।
...
टनल निर्माण विनिर्देशन [Tunnel-Creation]_ में कई परिवर्तन आवश्यक हैं ताकि ECIES के बजाय ElGamal का उपयोग किया जा सके।
...
यह परिवर्तन प्रस्ताव 152 [Prop152]_ में परिभाषित हैं।
...
यह परिवर्तन प्रस्ताव 157 [Prop157]_ में परिभाषित हैं।
...
ECIES-X25519-AEAD-Ratchet [Prop144]_ में, अब [ECIES]_ में निर्दिष्ट किया गया है।
...
- गंतव्यों के लिए [ECIES]_ में वर्णित "ड्यूल की" सेशन की मैनेजर्स चलाने की कोई आवश्यकता नहीं है। राउटरों के पास केवल एक ही सार्वजनिक कुंजी है।

डिजाइन निष्कर्ष
```````````````````````

ECIES राउटर SKM को गंतव्यों के लिए [ECIES]_ में निर्दिष्ट एक पूर्ण रैचेट SKM की आवश्यकता नहीं है।
...
इसलिए, राउटर SKM शोर "N" पैटर्न का उपयोग करेगा, जैसा कि [Prop152]_ में सुरंग निर्माण के लिए निर्दिष्ट है।
यह गंतव्यों के लिए [ECIES]_ में निर्दिष्ट पेलोड प्रारूप का उपयोग करेगा।
...
यह [Prop154]_, अब[I2NP]_ में निर्दिष्ट है में प्रलेखित है।
...
X25519: देखें [ECIES]_।

राउटर पहचान और कुंजी प्रमाणपत्र: देखें [Common]_।

टनल निर्माण: देखें [Prop152]_।

नया टनल निर्माण संदेश: देखें [Prop157]_।

### अनुरोध एन्क्रिप्शन

अनुरोध एन्क्रिप्शन वही है जैसा कि [Tunnel-Creation-ECIES]_ और [Prop152]_ में निर्दिष्ट है,
...
जैसा कि [I2NP]_ और [Prop154]_ में निर्दिष्ट है। उत्तर को एन्क्रिप्ट करने के लिए कुंजी और टैग का उपयोग किया जाता है।

टैग सेट नहीं बनाए जाते हैं।
शून्य स्थिर कुंजी योजना निर्दिष्ट 
ECIES-X25519-AEAD-Ratchet [Prop144]_ और [ECIES]_ में उपयोग नहीं किया जाएगा।
...
यह मानक [NOISE]_ है पैटर्न "N" के लिए एक मानक प्रोटोकॉल नाम के साथ।
यह वही है जैसा कि सुरंग निर्माण संदेशों के लिए [Tunnel-Creation-ECIES]_ और [Prop152]_ में निर्दिष्ट है।
...
पेलोड वही ब्लॉक प्रारूप है जैसा कि [ECIES]_ और [Prop144]_ में परिभाषित किया गया है।
...
जैसा कि [I2NP]_ और [Prop154]_ में निर्दिष्ट 32-बाइट उत्तर कुंजी और 8-बाइट उत्तर टैग के साथ एन्क्रिप्ट किए जाते हैं।
...
प्रस्तावना 145 [Prop145]_ या तो प्रस्ताव 152 [Prop152]_ के साथ ज्यादातर-संगत की तरह फिर से लिखा जा सकता है या नहीं।
...
यह अब संभव होना चाहिए, क्योंकि कई जाँचें प्रस्ताव 145 [Prop145]_ के अनुपूर्ण अपडेट को देखते हुए मिड-2019 तक जावा कोड बेस में जोड़ी गई थीं।
...
प्रस्ताव 152 [Prop152]_ में परिभाषित की तरह सुरंग निर्माण को कार्यान्वित करें।
...
बलात्कार के रूप में प्रस्ताव 144 [Prop144]_ में परिभाषित के अनुसार ECIES संदेशों (ज़ीरो स्थिर कुंजी के साथ) की ECIES बाढ़फिल पर स्वीकृहणत परीक्षण करें। 
...
प्रस्ताव 157 [Prop157]_ में परिभाषित के अनुसार नए टनल बिल्ड मैसेज का कार्यान्वयन और परीक्षण करें।
