...
इस प्रस्ताव के प्रतिनिधित्व भाग का एक विकल्प होगा एक [LeaseSet]_ हैश के माध्यम से भेजना, जैसा कि मौजूदा क्षमता के समान है एक लक्ष्य [RouterIdentity]_ हैश निर्दिष्ट करने की। इससे संदेश छोटा होगा और संभावित रूप से नया LeaseSet मिलेगा। हालाँकि:
...
4. LeaseSet निर्दिष्ट करने से OBEP को संदेश के [Destination]_ का पता चलता है, जिसे वे अन्यथा नेटवर्क में सभी LeaseSets को स्क्रैप करके और एक लीज़ मैच खोजकर ही जान सकते थे।


## डिज़ाइन

उद्गमकर्ता (OBGW) कुछ (सभी?) लक्षित [Leases]_ को डिलीवरी निर्देश [TUNNEL-DELIVERY]_ में रखेगा बजाय इसके कि केवल एक चयन करें।
...
हमारे पास एक अप्रयुक्त डिलीवरी प्रकार (0x03) और दो शेष बिट्स (0 और 1) [TUNNEL-DELIVERY]_ के लिए झंडे में हैं, जिन्हें हम इन विशेषताओं को लागू करने के लिए लाभ उठा सकते हैं।
...
- एक प्रतिद्वंद्वी जो OBEP को नियंत्रित करता है और NetDB से LeaseSets को स्क्रैप कर रहा है, पहले से ही यह निर्धारित कर सकता है कि क्या एक संदेश विशेष गंतव्य पर भेजा जा रहा है, [TunnelId]_ / [RouterIdentity]_ जोड़ी को खोजकर। सबसे खराब स्थिति में, TMDI में एकाधिक लीज़ की उपस्थिति इसे प्रतिद्वंद्विता के डेटाबेस में मैच खोजने के लिए तेज़ बना सकती है।
...
प्रथम खंड डिलीवरी निर्देशों [TUNNEL-DELIVERY]_ को निम्नानुसार संशोधित किया जाएगा:
...
केवल वे साथियों को नई विशिष्टता को समझने की आवश्यकता है जो OBGWs और OBEPs हैं। इसलिए हम इस परिवर्तन को मौजूदा नेटवर्क के साथ संगत बना सकते हैं लक्ष्य I2P संस्करण [VERSIONS]_ पर इसके उपयोग को सशर्त बना कर:

* OBGWs को आउटबाउंड टनल्स बनाते समय संगत OBEPs का चयन करना होगा, उनके [RouterInfo]_ में विज्ञापित I2P संस्करण के आधार पर।
