...
date: 2024-05-15
author: "zzz"
description: "2.5.2 रिलीज़, HTTP फिक्स सहित"
categories: ["release"]
---

I2P 2.5.2 को 2.5.0 में आए एक बग को ठीक करने के लिए जारी किया गया है, जो कुछ HTTP सामग्री के छँट जाने का कारण बन रहा था।
...
[सुधारे गए बगों की पूर्ण सूची](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.5.2)
