---
title: "Chave de Assinatura de Lançamento"
description: "Chaves PGP usadas para assinar lançamentos do I2P e onde obtê-las"
...
<p> As versões 0.9.57 em diante são assinadas por idk. Sua chave pública atual é: </p> <p> <a href="/idk.key.asc" >Baixar chave pública PGP</a> </p><p>

<p> As versões 0.7.6 e 0.9.56 são assinadas por zzz. Sua chave pública atual é: </p> <p> <a href="/zzz.key.asc" >Baixar chave pública PGP</a> </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1

Criei novas chaves GPG e subchaves e assinei as novas chaves com a chave antiga.
...
Usarei as novas chaves da seguinte forma:
...
A chave de assinatura de lançamento será usada a partir da versão 0.9.13. Esta mensagem está assinada com minha chave antiga.
...
<p> Versões a partir de 0.9.9 podem ser assinadas por str4d. Sua chave pública atual é: </p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA512

Minhas chaves públicas atuais são as seguintes:

pub   4096R/0EC51FCDA94FB53E 2014-03-11 [expira: 2019-03-10] uid               [completo] str4d (http://str4d.i2p) <str4d@mail.i2p> uid               [completo] str4d <str4d@i2pmail.org> sub   4096R/1CC61D9B33C3241B 2014-03-11 [expirado: 2015-03-11] sub   4096R/803DEE491A3473E7 2014-03-12 [expirado: 2015-03-12] sub   4096R/A1B84C9B733AAC82 2015-04-05 [expira: 2016-04-04] sub   4096R/13B5EE58C09FB3E0 2015-04-05 [expira: 2016-04-04]
...
Eu gero novas subchaves de criptografia e assinatura anualmente. Qualquer lançamento do I2P assinado por mim será sempre assinado com a subchave de assinatura mais recente no momento do lançamento.
...
<p> str4d assinou as seguintes versões: </p> <ul> <li>0.9.23</li> </ul>

<p> As versões 0.7.6 a 0.9.12 foram assinadas por zzz com a seguinte chave: </p> <p> <pre> -----BEGIN PGP PUBLIC KEY BLOCK----- Version: GnuPG v1.4.6 (GNU/Linux)
...
</pre> <p> As versões 0.6.1.31 até 0.7.5 foram assinadas por Complication. Sua chave pública é: </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1
...
Para pessoas que desejam copiar a chave diretamente desta mensagem, mas não estão lendo isto usando um programa de e-mail, lembre-se de excluir as sequências de escape "- " do marcador inicial e final do bloco de chave pública. Caso contrário, ela não será reconhecida.
