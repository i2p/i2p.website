...
I2P suporta uma [interface de plugins](/docs/specs/plugin/) padrão para desenvolvedores, de modo que aplicações possam ser facilmente integradas e distribuídas.
