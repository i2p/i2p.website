...
description: "Especificação detalhada e visão geral do ecossistema para BitTorrent dentro da rede I2P"
slug: "bittorrent"
lastUpdated: "2025-10"
accurateFor: "2.10.0"
---
...
Todas as conexões são executadas através da camada de transporte criptografada do I2P (NTCP2 ou SSU2). Até mesmo os pacotes de rastreador UDP são encapsulados dentro do streaming I2P.
...
Trackers `.i2p` padrão respondem a requisições HTTP GET como:
...
```
As respostas são **bencoded** e usam hashes de destino I2P para peers.

### Rastreadores UDP

Os trackers UDP foram padronizados em 2025 (Proposta 160).

**Rastreadores UDP Principais** - `udp://tracker2.postman.i2p/announce` - `udp://opentracker.simp.i2p/a` - `http://opentracker.skank.i2p/a` - `http://opentracker.dg2.i2p/a` ---
...
Links magnet suportam enxames híbridos através de I2P e clearnet quando configurados.

---

## 4. Implementações de DHT
...
## 5. Implementações de Cliente

### I2PSnark

- Incluído com todos os routers
- Suporte apenas para tracker HTTP
- Tracker integrado em `http://127.0.0.1:7658/`
- Sem suporte para tracker UDP

### BiglyBT

- Completo com plugin I2P
- Suporta rastreadores HTTP + UDP
- Suporte a torrents híbridos
- Usa interface SAM v3.3

### Tixati / XD

- Clientes leves
- Tunelamento baseado em SAM
- Criptografia híbrida ML-KEM experimental
...
Torrents híbridos (clearnet + I2P) devem ser usados apenas se o anonimato não for crítico.
...
As velocidades típicas variam entre **30–80 KB/s**, dependendo dos peers e das condições da rede.

---

## 9. Problemas Conhecidos

- Interoperabilidade parcial de DHT entre Java I2P e i2pd  
- Atraso na busca de metadados Magnet sob carga pesada  
- NTCP1 obsoleto mas ainda usado por peers antigos  
- UDP simulado sobre streaming aumenta a latência

---

## 10. Roteiro Futuro

- Multiplexação tipo QUIC  
- Integração completa do ML-KEM  
- Lógica unificada de swarm híbrido  
- Espelhos de reseed melhorados  
- Tentativas adaptativas de DHT
...
- [Proposta 160 – UDP Tracker sobre I2P](/proposals/160-udp-trackers/)
- [Documentação do I2PSnark](/docs/applications/bittorrent/)
- [Especificação da Biblioteca Streaming](/docs/specs/streaming/)
