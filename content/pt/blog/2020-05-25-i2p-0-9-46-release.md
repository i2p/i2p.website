---
title: "Lançamento 0.9.46"
date: 2020-05-25
author: "zzz"
description: "0.9.46 com nova criptografia ECIES"
categories: ["release"]
---

## Detalhes da atualização

0.9.46 contém melhorias significativas de desempenho na biblioteca de streaming. Concluímos o desenvolvimento da criptografia ECIES (proposta 144) e agora há uma opção para ativá-la para testes.

**Apenas para usuários do Windows**: Esta versão corrige uma vulnerabilidade de elevação de privilégios local que poderia ser explorada por um usuário local que tenha a capacidade de executar programas. Aplique a atualização o quanto antes. Agradecemos à Blaze Infosec pela divulgação responsável do problema.

Esta é a última versão que suporta Java 7, os pacotes do Debian para Wheezy e Stretch e os pacotes do Ubuntu para Precise e Trusty. Usuários nessas plataformas devem atualizar para receber futuras atualizações do I2P.
...
[Lista completa de erros corrigidos](http://trac.i2p2.i2p/query?resolution=fixed&milestone=0.9.46)
