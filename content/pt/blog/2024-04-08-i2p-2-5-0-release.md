---
title: "Nova versão do I2P 2.5.0"
date: 2024-04-08
author: "idk"
description: "Lançamento do I2P 2.5.0"
categories: ["release"]
---

Esta versão, I2P 2.5.0, oferece mais melhorias voltadas para o usuário do que a versão 2.4.0, que estava focada na implementação da estratégia de isolamento do NetDB.
...
Nesta versão também fizemos vários ajustes ao NetDB para melhorar sua resiliência ao spam e a capacidade do router de rejeitar mensagens suspeitas. Isso fez parte de um esforço para "auditar" a implementação das defesas de "Sub-DB isolation" da versão 2.4.0. Esta investigação revelou um pequeno evento de quebra de isolamento, que corrigimos. Esse problema foi descoberto e corrigido internamente pela equipe do I2P.

Nesta versão, foram feitas várias melhorias no processo de lançamento das nossas distribuições derivadas para Android e Windows. Isso deve resultar em melhorias na entrega e na disponibilidade desses produtos derivados.
...
[Lista completa de bugs corrigidos](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.5.0)
