...
Todos os binários e pacotes de código-fonte estão em [syndie.de](https://syndie.de/download) e [syndie.i2p](http://www.syndie.i2p/download.html). Os plugins estão disponíveis em [plugins.i2p](http://plugins.i2p/plugins/syndie/) e [stats.i2p](http://stats.i2p/i2p/plugins/).
