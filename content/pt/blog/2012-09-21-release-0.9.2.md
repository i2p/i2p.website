---
title: "Lançamento 0.9.2"
date: 2012-09-21
author: "zzz"
description: "0.9.2 inclui alterações extensas de baixo nível para melhorar o desempenho e a eficiência do router. Atualizamos a nossa biblioteca UPnP, na esperança de fazer com que o UPnP funcione para mais pessoas."
categories: ["release"]
---

0.9.2 inclui extensas alterações de baixo nível para melhorar o desempenho e a eficiência do router. Atualizamos nossa biblioteca de UPnP, na esperança de que o UPnP funcione para mais pessoas. O I2PSnark agora tem suporte a DHT (tabela hash distribuída), mas ainda não está habilitado por padrão, pois planejamos realizar mais testes durante o próximo ciclo de desenvolvimento 0.9.3.

Como de costume, há também muitas correções de erros nesta versão, portanto recomenda-se a atualização.
