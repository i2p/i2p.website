...
date: 2014-01-22
author: "zzz"
description: "0.9.10 altera o mecanismo para realizar consultas de LeaseSet, tornando mais difícil para um atacante correlacionar uma Destination com um Router."
categories: ["release"]
---

A versão 0.9.10 altera o mecanismo para realizar consultas de LeaseSet, tornando mais difícil para um atacante correlacionar um Destination (destino I2P) com um Router. Ela também corrige bugs de codificação de caracteres no susimail e inclui várias outras correções de bugs e atualizações de tradução. A maioria de vocês atualizará via torrent, usando o novo formato de atualização "su3" com chaves mais fortes.

Recentemente participamos do [30C3](https://events.ccc.de/congress/2013/wiki/Main_Page) e do [Real World Crypto](http://realworldcrypto.wordpress.com/), estabelecendo várias novas conexões e formulando [grandes planos](http://zzz.i2p) para 2014. Agradecemos aos que apoiaram nossa participação com suas [doações](http://i2p-projekt.i2p/donate)!
