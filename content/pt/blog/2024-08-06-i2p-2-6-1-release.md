...
date: 2024-08-06
author: "idk"
description: "Versão 2.6.1 com correção na interface do usuário do I2PTunnel"
categories: ["release"]
---

I2P 2.6.1 foi lançado para corrigir um bug na interface do usuário na aplicação Hidden Services Manager (Gerenciador de Serviços Ocultos). Esse bug desativava a rolagem, tornando algumas configurações inacessíveis.
...
[Lista completa de erros corrigidos](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.6.1)
