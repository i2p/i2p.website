...
date: 2022-11-21
author: "zzz"
description: "2.0.0 habilita o SSU2"
categories: ["release"]
---

## Detalhes da atualização

A versão 2.0.0 do I2P habilita nosso novo transporte UDP SSU2 para todos os usuários, após a conclusão de recursos menores, testes e inúmeras correções de bugs.

Também fizemos correções em diversas áreas, incluindo no instalador, no banco de dados da rede, na adição ao livro de endereços privado, no iniciador do navegador do Windows e no UPnP para IPv6.
...
[Lista completa de erros corrigidos](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.0.0)
