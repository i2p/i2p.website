...
resistência do [NTCP]_ a várias formas de identificação automatizada e ataques.
...
Os dados do [NTCP]_ são criptografados após a primeira mensagem (e a primeira mensagem
...
um protocolo existente como TLS, mas este é [Prop104]_ e tem seus próprios problemas.
...
- Corrigir perda de bits em DH devido ao formato Java [Ticket1112]_, possivelmente
...
- Continuar a usar assinaturas de tipo variável e comprimento variável (da
  chave de assinatura [RouterIdentity]_) como parte da autenticação. Confiar
...
- Se possível, reduzir o aperto de mão de 4 mensagens, duas viagens de ida e volta,
  para um aperto de mão de 3 mensagens, uma viagem de ida e volta, como no [SSU]_.
...
- Um transporte baseado em TLS (ou parecendo com HTTPS)... isso seria [Prop104]_.
