...
especificação [Tunnel-Creation-ECIES]_ a partir da API 0.9.65.
...
Adicione parâmetros de largura de banda aos registros em mensagens de construção de túnel ECIES [Tunnel-Creation-ECIES]_
...
Atualize a especificação da mensagem de construção de túnel ECIES [Tunnel-Creation-ECIES]_
da seguinte forma:
