...
[Prop123]_ define um formato criptografado LeaseSet2 que incorpora o Princípio de Menor
...
O esquema de assinatura descrito nesta proposta, Red25519, é uma instância do [RedDSA]_,
...
B
    O ponto base Ed25519 como em [RFC-8032]_.

L
    A ordem Ed25519 2^252 + 27742317777372353535851937790883648493, como em [RFC-8032]_.
...
a seção 5.4.6 de [RedDSA]_ para a especificação geral das funções RedDSA.
...
nos passos 1-3 da seção 5.1.5 de [RFC-8032]_.
