...
Phần mềm cốt lõi (Java) bao gồm một bộ định tuyến giới thiệu và duy trì một kết nối với mạng. Nó cũng cung cấp các ứng dụng và tùy chọn cấu hình để cá nhân hóa trải nghiệm và quy trình làm việc của bạn. Tìm hiểu thêm trong [tài liệu của chúng tôi](/en/docs/).
