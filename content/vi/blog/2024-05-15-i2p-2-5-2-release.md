---
title: "2.5.2 Phát hành"
date: 2024-05-15
author: "zzz"
description: "2.5.2 Bản phát hành kèm sửa lỗi HTTP"
categories: ["release"]
---

I2P 2.5.2 đã được phát hành để sửa một lỗi phát sinh trong 2.5.0, gây ra hiện tượng cắt ngắn một số nội dung HTTP.
...
[Danh sách đầy đủ các lỗi đã được sửa](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.5.2)
