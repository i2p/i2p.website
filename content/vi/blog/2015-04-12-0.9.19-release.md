...
date: 2015-04-12
author: "zzz"
description: "0.9.19 with performance improvements and bug fixes"
categories: ["release"]
---

0.9.19 has several fixes and improvements for floodfill performance. Many of you saw high CPU usage after 0.9.18 was released. This was caused by a combination of increased encryption usage, the big influx of Vuze users into the network, reduced floodfills due to tighter performance requirements, and some longstanding bugs. Things should be a lot better after most of the network has updated. As always, the best way to reduce CPU usage is to lower your bandwidth limits.

We've also added new ways to reseed manually, and to generate a reseed file you can easily share with others who need it. See the reseed configuration page in the router console for more information.
