---
title: "Bản phát hành 0.9"
date: 2012-05-02
author: "zzz"
description: "Bản phát hành 0.9 đánh dấu sự kết thúc của hơn một năm rưỡi làm việc trên dòng 0.8.x, trong đó chúng tôi đã cải thiện đáng kể hiệu năng và bảo mật của router, cũng như khả năng mở rộng của mạng."
categories: ["release"]
---

Bản phát hành 0.9 khép lại hơn một năm rưỡi làm việc trên dòng 0.8.x, trong đó chúng tôi đã cải thiện đáng kể hiệu năng và bảo mật của router, cũng như khả năng mở rộng của mạng.

Trong bản phát hành 0.9, chúng tôi chuyển sang Jetty 6 cho bảng điều khiển và máy chủ web eepsite, và giới thiệu một trang chủ bảng điều khiển router được đơn giản hóa. Bản phát hành này tương thích ở cấp độ mạng với các bản phát hành trước; tuy nhiên, hãy xem bên dưới để biết thông tin quan trọng về khả năng tương thích với các eepsites hiện có, các plugin và ứng dụng web. Khuyến nghị nâng cấp.

Các tệp có sẵn trên [trang tải xuống](/downloads).

## Thông tin cập nhật

Các bản cập nhật trong mạng và các cài đặt mới sẽ bao gồm Jetty 6, Tomcat và JSTL. Các bản cập nhật PPA (Ubuntu/Debian) sẽ có các phụ thuộc mới cho các gói này.

Nếu bạn chưa kích hoạt hoặc chỉnh sửa cài đặt eepsite của mình, bản cập nhật sẽ tự động chuyển sang Jetty 6. Nếu bạn không sử dụng Jetty cho eepsite của mình, bản cập nhật sẽ không ảnh hưởng đến nó.

Nếu bạn có nhiều hơn một eepsite Jetty hoặc bạn đã thay đổi cổng cục bộ (7658 theo mặc định) hoặc đã có chỉnh sửa khác đối với jetty.xml, thì sau khi cập nhật bạn phải chỉnh sửa thủ công các tệp cấu hình Jetty mới, rồi khởi động lại.

Đối với những ai có eepsites (trang web ẩn trên I2P) chạy trên Jetty, chúng tôi khuyến nghị bạn xác minh rằng việc nâng cấp đã thành công và các eepsites đang hoạt động bình thường sau khi router khởi động lại.

## Thông tin về phần bổ trợ
...
Các ứng dụng web cho bảng điều khiển và eepsite không tiêu chuẩn khác, không do nhóm phát triển I2P đóng gói, có thể cần hoặc không cần sửa đổi.
