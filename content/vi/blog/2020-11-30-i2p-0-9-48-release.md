---
title: "Bản phát hành 0.9.48"
date: 2020-11-30
author: "zzz"
description: "0.9.48 với các cải tiến hiệu năng"
categories: ["release"]
---

## Chi tiết cập nhật

0.9.48 kích hoạt giao thức mã hóa đầu-cuối mới của chúng tôi (đề xuất 144) cho hầu hết các dịch vụ. Chúng tôi đã bổ sung hỗ trợ ban đầu cho mã hóa thông điệp xây dựng tunnel mới (đề xuất 152). Có những cải thiện hiệu năng đáng kể trên toàn bộ router.

Các gói cho Ubuntu Xenial (16.04 LTS) không còn được hỗ trợ nữa. Người dùng trên nền tảng đó nên nâng cấp để tiếp tục nhận các bản cập nhật I2P.
...
[Danh sách đầy đủ các lỗi đã được sửa](http://trac.i2p2.i2p/query?resolution=fixed&milestone=0.9.48)
