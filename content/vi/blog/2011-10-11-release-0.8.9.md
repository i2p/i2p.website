---
title: "Bản phát hành 0.8.9"
date: 2011-10-11
author: "zzz"
description: "Bản phát hành 0.8.9 có một số cải tiến về hiệu năng và nhiều thay đổi để đáp ứng sự tăng trưởng nhanh chóng và liên tục của mạng lưới."
categories: ["release"]
---

Bản phát hành 0.8.9 có một số cải tiến về hiệu năng và nhiều thay đổi để xử lý sự tăng trưởng nhanh chóng liên tục của mạng lưới. Nó sử dụng một phương pháp lặp mới cho việc tra cứu cơ sở dữ liệu mạng Kademlia, được kỳ vọng sẽ đáng tin cậy và hiệu quả hơn. Cũng có một số cải tiến đối với giao thức truyền tải SSU (UDP) của chúng tôi nhằm giúp tăng độ tin cậy và hiệu quả. Chúng tôi đã thực hiện một số thay đổi để cải thiện tỷ lệ thành công khi xây dựng tunnel. Và, dĩ nhiên, có rất nhiều bản sửa lỗi và cập nhật bản dịch.

Mạng lưới đã tăng trưởng khá nhanh trong vài tuần gần đây; điều đó thật đáng mừng nhưng cũng đã gây ra một số bất ổn. Chúng tôi chào mừng tất cả người dùng mới và mong mọi người kiên nhẫn trong khi chúng tôi cải thiện phần mềm.

Hãy giúp mở rộng mạng lưới. [Tham gia](/get-involved), lan tỏa thông tin, và [quyên góp](/en/get-involved/#donate)! Nếu bạn phát hiện lỗi, vui lòng gửi báo cáo trên [Trac](http://trac.i2p2.i2p/report/1). Chúng tôi vẫn đang tìm kiếm sự hỗ trợ cho các bản dịch mới và hiện có. Vui lòng đăng ký tình nguyện trên IRC #i2p-dev.

Các tệp có sẵn tại [trang tải xuống](/downloads).
