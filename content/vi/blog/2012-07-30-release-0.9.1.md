---
title: "Bản phát hành 0.9.1"
date: 2012-07-30
author: "zzz"
description: "0.9.1 bao gồm rất nhiều bản sửa lỗi trong i2psnark, một số cải tiến cho streaming lib (thư viện truyền dữ liệu dạng dòng), các thay đổi ở trang chủ, các chủ đề mới và các cập nhật bản dịch."
categories: ["release"]
---

0.9.1 bao gồm rất nhiều bản sửa lỗi trong i2psnark, một số cải tiến đối với streaming lib (thư viện phát trực tuyến), các thay đổi ở trang chủ, các chủ đề mới và cập nhật bản dịch. Khuyến nghị nâng cấp.
