...
All binaries and source packages are at [syndie.de](https://syndie.de/download) and [syndie.i2p](http://www.syndie.i2p/download.html). Plugins are available at [plugins.i2p](http://plugins.i2p/plugins/syndie/) and [stats.i2p](http://stats.i2p/i2p/plugins/).
