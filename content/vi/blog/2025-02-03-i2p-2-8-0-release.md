---
title: "I2P 2.8.0 đã được phát hành"
date: 2025-02-04
author: "idk"
description: "I2P 2.8.0 đã được phát hành"
categories: ["release"]
---

Bản phát hành này cải thiện I2P bằng cách sửa lỗi, loại bỏ mã không dùng, và nâng cao độ ổn định của mạng.
...
[Danh sách đầy đủ các lỗi đã được sửa](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.8.0)
