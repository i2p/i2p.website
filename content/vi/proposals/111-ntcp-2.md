...
Đề xuất này mô tả một giao thức thỏa thuận khóa có xác thực nhằm cải thiện khả năng chống lại các hình thức nhận dạng tự động và tấn công khác nhau của [NTCP](/docs/ntcp/).
...
Các tác giả thừa nhận rằng các thực hành bảo mật tiêu chuẩn sẽ đề xuất sử dụng một giao thức hiện có như TLS, nhưng đây là [Prop104](/proposals/104-tls-transport/) và nó có những vấn đề riêng của mình. Ở những chỗ thích hợp, các đoạn "công việc tương lai" đã được thêm vào để chỉ ra các tính năng còn thiếu hoặc chủ đề thảo luận.
...
- Một giao thức vận chuyển dựa trên TLS (hoặc giống HTTPS)... đó sẽ là [Prop104](/proposals/104-tls-transport/).
