...
kháng cự của [SSU]_ đối với các hình thức nhận diện tự động và các cuộc tấn công.
...
Giống như [SSU]_, nó cũng cung cấp hai dịch vụ bổ sung:
...
- Hỗ trợ SSU 1 và 2 trên một cổng duy nhất, tự động nhận diện, và được công bố như một
  "phương tiện" duy nhất (tức là [RouterAddress]_) trong [NetDB]_.
...
- Sửa chữa mất bit trong DH do định dạng Java [Ticket1112]_, và tăng tốc DH
...
- Sử dụng bắt tay 3 thông điệp, một chuyến đi vòng, như trong [NTCP2]_.
  Bỏ qua độ trễ chờ các thông điệp dữ liệu khiến cho
  [SSU]_ trở thành một tục đoạn hai lượt vòng.
...
- Một phương tiện dựa trên TLS (hoặc giống như HTTPS)... đó sẽ là [Prop104]_.
...
Alice và Bob đều có một cặp khóa tĩnh, được chứa trong [RouterIdentity]_ của họ.
...
Station-To-Station (STS) [STS]_. Lưu ý rằng giao thức này cũng là
cơ sở cho giao thức [SSU]_.
...
Sau đây được sao chép từ QUIC [RFC-9000]_.
