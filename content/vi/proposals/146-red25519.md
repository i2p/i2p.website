...
[Prop123]_ định nghĩa một định dạng LeaseSet2 mã hóa tuân thủ Nguyên tắc quyền hạn tối thiểu: mỗi người tham gia mạng chỉ được cung cấp thông tin cần thiết cho vai trò của họ. Đặc biệt, một LeaseSet2 mã hóa được công bố đến một floodfill không tiết lộ
...
[RedDSA]_, một sơ đồ chữ ký dựa trên Schnorr hỗ trợ ngẫu nhiên khóa. Nó có các chức năng sau:
...
B
    Điểm gốc của Ed25519 như trong [RFC-8032]_.

L
    Thứ tự Ed25519 2^252 + 27742317777372353535851937790883648493 như trong [RFC-8032]_.
...
Để dễ dàng triển khai, chúng tôi viết rõ ràng dưới đây các hàm RedDSA (cũng như một số hàm trợ giúp) đã chuyên biệt cho Red25519. Các nhà triển khai nên tham khảo phần 5.4.6 của [RedDSA]_ để biết đặc tả chung của các hàm RedDSA.
...
Lưu ý rằng việc triển khai ``CONVERT_ED25519_PRIVATE`` tương đương với phép tính của scalar bí mật s khi dẫn xuất một khóa công khai Ed25519 từ một khóa riêng Ed25519, như được chỉ định trong các bước 1-3 từ phần 5.1.5 của [RFC-8032]_.
