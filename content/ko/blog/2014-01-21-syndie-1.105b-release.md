...
모든 바이너리와 소스 패키지는 [syndie.de](https://syndie.de/download) 및 [syndie.i2p](http://www.syndie.i2p/download.html)에 있습니다. 플러그인은 [plugins.i2p](http://plugins.i2p/plugins/syndie/) 및 [stats.i2p](http://stats.i2p/i2p/plugins/)에서 이용할 수 있습니다.
