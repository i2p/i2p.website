...
사소한 수정이 있을 수 있습니다.
공식 사양은 [SPEC](/en/docs/spec/ecies/)을 참조하십시오.
...
ElGamal/AES+SessionTags [Elg-AES](/en/docs/spec/elgamal-aes/)을 대체할 것입니다.

다음과 같은 이전 작업에 의존합니다:

- 공통 구조 사양 [Common](/en/docs/spec/common-structures/)
- LS2를 포함한 [I2NP](/en/docs/spec/i2np/) 사양
- ElGamal/AES+Session Tags [Elg-AES](/en/docs/spec/elgamal-aes/)
- 새로운 비대칭 암호화 개요 http://zzz.i2p/topics/1768
- 저수준 암호화 개요 [CRYPTO-ELG](/en/docs/how/cryptography/)
- ECIES http://zzz.i2p/topics/2418
- [NTCP2](/en/docs/transport/ntcp2/) [Prop111](/en/proposals/111-ntcp2/)
- 123 새로운 netDB 항목
- 142 새로운 암호화 템플릿
- [Noise](https://noiseprotocol.org/noise.html) 프로토콜
- [Signal](https://signal.org/docs/specifications/doubleratchet/) 이중 라쳇 알고리즘
...
이를 변경할지는 TBD입니다.
공통 구조 사양 [Common](/en/docs/spec/common-structures/)을 참조하십시오.
...
1) 터널 빌드 메시지 (키는 RouterIdentity에 있음)
   ...
   제안서 152 [Prop152](/en/proposals/152-ecies-tunnels/)를 참조하십시오.
...
- 터널 빌드의 새로운 암호화.
  제안서 152 참조 [Prop152](/en/proposals/152-ecies-tunnels/).
- 터널 레이어 암호화의 새로운 암호화.
  제안서 153 참조 [Prop153](/en/proposals/153-ecies-garlic/).
...
자세한 내용은 [NOISE](https://noiseprotocol.org/noise.html)의 Noise "페이로드 보안 속성" 표를 참조하십시오.
...
아직 [NTCP2](/en/docs/transport/ntcp2/) ([Prop111](/en/proposals/111-ntcp2/))이 구현되지 않은 기존 I2P 라우터 구현은 다음과 같은 구현도 필요합니다:
...
암호화 타입 1-3은 제안서 145 [Prop145](/en/proposals/145-ecies/)를 참조하십시오.


### Noise 프로토콜 프레임워크

이 제안서는 Noise 프로토콜 프레임워크 [NOISE](https://noiseprotocol.org/noise.html)(Revision 34, 2018-07-11)를 기반으로 요구 사항을 제공합니다.
Noise는 [SSU](/en/docs/transport/ssu/) 프로토콜의 기반이 되는 Station-To-Station 프로토콜 [STS](https://en.wikipedia.org/wiki/Station-to-Station_protocol)과 유사한 속성을 가지고 있습니다. Noise 말을 빌리자면, 앨리스는 시작자이고, 밥은 응답자입니다.
...
- 암호 함수: ChaChaPoly
  ...
  이는 [NTCP2](/en/docs/transport/ntcp2/)에서와 동일합니다.
...
이 제안서는 Noise_IK_25519_ChaChaPoly_SHA256에 대한 다음과 같은 개선 사항을 정의합니다. 일반적으로 [NOISE](https://noiseprotocol.org/noise.html) 섹션 13의 지침을 따릅니다.

1) 평문 일회용 키는 [Elligator2](https://elligator.org/)로 인코딩됩니다.
...
모든 메시지에는 [I2NP](/en/docs/spec/i2np/) Garlic 메시지 헤더가 포함됩니다.
