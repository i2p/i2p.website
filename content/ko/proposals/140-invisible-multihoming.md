...
이 제안서는 I2P 클라이언트나 서비스 또는 외부 로드 밸런서 프로세스가 단일 [Destination]_을 투명하게 호스팅하는 여러 라우터를 관리할 수 있는 프로토콜 디자인을 설명합니다.
...
이 제안서는 LeaseSet 당 16 [Leases]_의 상한을 변경하지 않습니다. 더 많은 터널이 필요한 Destination의 경우, 두 가지 가능한 네트워크 수정이 있습니다:
