...
Java I2P에서는 구성된 호스트 이름을 두 발행 전송 모두로 전파하는 것이 항상 도전 과제였으며, IPv6과 함께 상황은 더욱 복잡해졌습니다. 티켓 1050 http://trac.i2p2.i2p/ticket/1050이 이러한 문제를 자세히 설명합니다. 듀얼 스택 호스트가 호스트 이름과 리터럴 IPv6 주소를 모두 발행해야 하는지는 불명확합니다. 호스트 이름은 SSU 주소에 대해 발행되지만 NTCP 주소에는 발행되지 않습니다.
...
관련 섹션은 전송 사양의 "Router Address Specification"입니다:  
