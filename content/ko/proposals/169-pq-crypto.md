...
2022년 [FORUM]_에 PQ 암호의 영향을 조사하기 시작했습니다.

TLS 표준은 지난 2년 동안 하이브리드 암호화 지원을 추가했으며, 이는 크롬과 파이어폭스의 지원으로 인해 인터넷에서 암호화된 트래픽에서 상당한 비중을 차지하게 되었습니다 [CLOUDFLARE]_.

NIST는 최근 포스트 양자 암호화에 대한 권장 알고리즘을 최종화 및 발표했습니다 [NIST-PQ]_. 여러 일반적인 암호화 라이브러리는 이제 NIST 표준을 지원하거나 가까운 미래에 지원을 발표할 것입니다.

[CLOUDFLARE]_ 및 [NIST-PQ]_는 즉시 마이그레이션을 시작할 것을 권장합니다. 2022년 NSA PQ FAQ [NSA-PQ]_도 참조하십시오. I2P는 보안과 암호화의 선두주자여야 합니다. 이제 권장 알고리즘을 구현할 때입니다. 우리의 유연한 암호 유형 및 서명 유형 시스템을 사용하여 하이브리드 암호화 및 PQ와 하이브리드 서명을 위한 유형을 추가할 것입니다.
...
프로토콜 / 기능                   상태
==================================  ======
하이브리드 MLKEM Ratchet 및 LS         승인 2026-06; 베타 목표 2025-08; 릴리스 목표 2025-11
하이브리드 MLKEM NTCP2                   일부 세부 정보 마무리 필요
하이브리드 MLKEM SSU2                    일부 세부 정보 마무리 필요
MLDSA SigTypes 12-14                      제안이 안정적이나 2026년까지 최종화되지 않을 수 있음
MLDSA Dests                               라이브 네트에서 테스트, 홍수 채우기 지원을 위한 네트업그레이드 필요
...
NIST FIPS 203 및 204 표준 [FIPS203]_ [FIPS204]_을 지원할 것이며,
...
[FIPS203]_에 정의된 대로 세 가지 ML-KEM 변형을 정의하여 총 3개의 새로운 암호화 유형을 제공합니다.
...
SU3 files                   예                예
X.509 certificates          예                예
Java keystores              예                예
==========================  ================  ===============

따라서 PQ 전용 및 하이브리드 서명 모두를 지원할 것입니다.
[FIPS204]_에 정의된 대로 세 가지 ML-DSA 변형을 정의하고,
...
"determinstic" 변형은 사용하지 않습 as [FIPS204]_ 섹션 3.4에 정의되어 있습니다.
...
X.509 인증서 및 기타 DER 인코딩은 [COMPOSITE-SIGS]_에 정의된 합성 구조 및 OID를 사용할 것입니다.
...
- ML-KEM(이전 CRYSTALS-Kyber) [FIPS203]_
- ML-DSA(이전 CRYSTALS-Dilithium) [FIPS204]_
...
공통 구조 문서 [COMMON]_의 섹션 및 테이블을 다음과 같이 업데이트합니다:
...
================    ================= ======  =====
  유형              공개 키 길이         이후   사용법
================    ================= ======  =====
MLKEM512_X25519               32      0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
MLKEM768_X25519               32      0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
MLKEM1024_X25519              32      0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
MLKEM512                     800      0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
MLKEM768                    1184      0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
MLKEM1024                   1568      0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
MLKEM512_CT                  768      0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
MLKEM768_CT                 1088      0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
MLKEM1024_CT                1568      0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
NONE                           0      0.9.xx  제안서 169 참조, RI 또는 리즈셋이 아닌 PQ 서명 유형 목적지에 해당
================    ================= ======  =====

하이브리드 공개 키는 X25519 키입니다.
KEM 공개 키는 Alice에서 Bob으로 전송되는 일시적인 PQ 키입니다.
인코딩 및 바이트 순서는 [FIPS203]_에 정의되어 있습니다.
...
MLKEM768_X25519               32       0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
MLKEM1024_X25519              32       0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
MLKEM512                    1632       0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
MLKEM768                    2400       0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
MLKEM1024                   3168       0.9.xx  제안서 169 참조, 리즈셋 또는 목적지가 아닌 핸드셰이크만 해당
================    ================== ======  =====

하이브리드 개인 키는 X25519 키입니다.
KEM 개인 키는 Alice만을 위한 것입니다.
KEM 인코딩 및 바이트 순서는 [FIPS203]_에 정의되어 있습니다.
...
MLDSA44ph                            1344      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
MLDSA65ph                            1984      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
MLDSA87ph                            2624      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
============================   ==============  ======  =====

하이브리드 서명 공개 키는 [COMPOSITE-SIGS]_에서 정의된 대로 Ed25519 키와 PQ 키가 결합된 것입니다.
인코딩 및 바이트 순서는 [FIPS204]_에 정의되어 있습니다.
...
============================   ==============  ======  =====
         유형                  길이 (바이트)   이후   사용법
============================   ==============  ======  =====
MLDSA44                              2560      0.9.xx  제안서 169 참조
MLDSA65                              4032      0.9.xx  제안서 169 참조
MLDSA87                              4896      0.9.xx  제안서 169 참조
MLDSA44_EdDSA_SHA512_Ed25519         2592      0.9.xx  제안서 169 참조
MLDSA65_EdDSA_SHA512_Ed25519         4064      0.9.xx  제안서 169 참조
MLDSA87_EdDSA_SHA512_Ed25519         4928      0.9.xx  제안서 169 참조
MLDSA44ph                            2592      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
MLDSA65ph                            4064      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
MLDSA87ph                            4928      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
============================   ==============  ======  =====

하이브리드 서명 개인 키는 [COMPOSITE-SIGS]_에서 정의된 대로 Ed25519 키와 PQ 키가 결합된 것입니다.
인코딩 및 바이트 순서는 [FIPS204]_에 정의되어 있습니다.
...
============================   ==============  ======  =====
         유형                  길이 (바이트)   이후   사용법
============================   ==============  ======  =====
MLDSA44                              2420      0.9.xx  제안서 169 참조
MLDSA65                              3309      0.9.xx  제안서 169 참조
MLDSA87                              4627      0.9.xx  제안서 169 참조
MLDSA44_EdDSA_SHA512_Ed25519         2484      0.9.xx  제안서 169 참조
MLDSA65_EdDSA_SHA512_Ed25519         3373      0.9.xx  제안서 169 참조
MLDSA87_EdDSA_SHA512_Ed25519         4691      0.9.xx  제안서 169 참조
MLDSA44ph                            2484      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
MLDSA65ph                            3373      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
MLDSA87ph                            4691      0.9.xx  SU3 파일 전용, netdb 구조에는 사용 안 함
============================   ==============  ======  =====

하이브리드 서명은 [COMPOSITE-SIGS]_에 정의된 대로 Ed25519 서명과 PQ 서명을 결합한 것입니다.
...
============================  ===========  =======================  ======  =====
        유형                  유형 코드      총 공개 키 길이         이후   사용법
============================  ===========  =======================  ======  =====
MLDSA44                           12                 1312           0.9.xx  제안서 169 참조
MLDSA65                           13                 1952           0.9.xx  제안서 169 참조
MLDSA87                           14                 2592           0.9.xx  제안서 169 참조
MLDSA44_EdDSA_SHA512_Ed25519      15                 1344           0.9.xx  제안서 169 참조
MLDSA65_EdDSA_SHA512_Ed25519      16                 1984           0.9.xx  제안서 169 참조
MLDSA87_EdDSA_SHA512_Ed25519      17                 2624           0.9.xx  제안서 169 참조
============================  ===========  =======================  ======  =====
...
================    ===========  ======================= ======  =====
  유형              유형 코드      총 공개 키 길이         이후   사용법
================    ===========  ======================= ======  =====
MLKEM512_X25519          5                 32            0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
MLKEM768_X25519          6                 32            0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
MLKEM1024_X25519         7                 32            0.9.xx  제안서 169 참조, RI 또는 목적지가 아닌 리즈셋만 해당
...
============================  ===========  =======================  ======  ======  =====
        유형                  유형 코드      총 공개 키 길이         메인    초과    총 목적지 길이
============================  ===========  =======================  ======  ======  =====
...
============================  ===========  =======================  ======  ======  =====
        유형                  유형 코드      총 공개 키 길이         메인    초과    총 RouterIdent 길이
============================  ===========  =======================  ======  ======  =====
...
ECIES-Ratchet 명세 [ECIES]_를 다음과 같이 업데이트하십시오:
...
================    =========  =====  =========  =============  =============  ==========  =======
  유형              유형 코드  Y 길이 메시지 2 길이  메시지 2 암호화 길이 메시지 2 복호화 길이  PQ CT 길이  opt 길이
================    =========  =====  =========  =============  =============  ==========  =======
...
ratchet 명세서 [ECIES]_에서는 이를 요구하지 않으므로 페이로드의 최소 크기는 0입니다.
...
NTCP2 명세를 다음과 같이 업데이트하십시오 [NTCP2]_ :
...
================    =========  =====  =========  =============  =============  ==========  =======
  유형              유형 코드  X 길이 메시지 1 길이  메시지 1 암호화 길이 메시지 1 복호화 길이  PQ 키 길이  opt 길이
================    =========  =====  =========  =============  =============  ==========  =======
...
SSU2 명세를 다음과 같이 업데이트하십시오 [SSU2]_ :
...
================    =========  =====  =========  =============  =============  ==========  =======
  유형              유형 코드  Y 길이 메시지 2 길이  메시지 2 암호화 길이  메시지 2 복호화 길이  PQ CT 길이  pl 길이
================    =========  =====  =========  =============  =============  ==========  =======
X25519                   4       32     80+pl        16+pl             pl            --         pl
