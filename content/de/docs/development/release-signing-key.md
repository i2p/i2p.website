---
title: "Release-Signaturschlüssel"
description: "PGP-Schlüssel, die zum Signieren von I2P-Releases verwendet werden, und wo man sie erhält"
...
<p> Releases 0.9.57 und später sind von idk signiert. Sein aktueller öffentlicher Schlüssel ist: </p> <p> <a href="/idk.key.asc" >PGP-öffentlichen Schlüssel herunterladen</a> </p><p>

<p> Die Versionen 0.7.6 und 0.9.56 sind von zzz signiert. Sein aktueller öffentlicher Schlüssel ist: </p> <p> <a href="/zzz.key.asc" >PGP-öffentlichen Schlüssel herunterladen</a> </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1

Ich habe neue GPG-Schlüssel und Unterschlüssel erstellt und die neuen Schlüssel mit dem alten Schlüssel signiert.
...
Ich werde die neuen Schlüssel wie folgt verwenden:
...
Der Release-Signierungsschlüssel wird ab Version 0.9.13 verwendet. Diese Nachricht ist mit meinem alten Schlüssel signiert.
...
<p> Releases ab Version 0.9.9 könnten von str4d signiert worden sein. Sein aktueller öffentlicher Schlüssel ist: </p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA512

Meine aktuellen öffentlichen Schlüssel lauten wie folgt:

pub   4096R/0EC51FCDA94FB53E 2014-03-11 [läuft ab: 2019-03-10] uid               [  voll  ] str4d (http://str4d.i2p) <str4d@mail.i2p> uid               [  voll  ] str4d <str4d@i2pmail.org> sub   4096R/1CC61D9B33C3241B 2014-03-11 [abgelaufen: 2015-03-11] sub   4096R/803DEE491A3473E7 2014-03-12 [abgelaufen: 2015-03-12] sub   4096R/A1B84C9B733AAC82 2015-04-05 [läuft ab: 2016-04-04] sub   4096R/13B5EE58C09FB3E0 2015-04-05 [läuft ab: 2016-04-04]
...
Ich erstelle jährlich neue Verschlüsselungs- und Signatur-Unterschlüssel. Jede I2P-Version, die von mir signiert wird, wird immer mit dem zum Zeitpunkt der Veröffentlichung aktuellsten Signatur-Unterschlüssel signiert.
...
<p> str4d hat die folgenden Versionen signiert: </p> <ul> <li>0.9.23</li> </ul>

<p> Die Versionen 0.7.6 bis 0.9.12 wurden von zzz mit folgendem Schlüssel signiert: </p> <p> <pre> -----BEGIN PGP PUBLIC KEY BLOCK----- Version: GnuPG v1.4.6 (GNU/Linux)
...
</pre> <p> Die Versionen 0.6.1.31 bis 0.7.5 wurden von Complication signiert. Sein öffentlicher Schlüssel lautet: </p> <p> <pre> -----BEGIN PGP SIGNED MESSAGE----- Hash: SHA1
...
Für Personen, die den Schlüssel direkt aus dieser Nachricht kopieren möchten, aber diese nicht mit einem E-Mail-Programm lesen, denken Sie bitte daran, die "- " Escape-Sequenzen am Anfang und Ende des öffentlichen Schlüsselblocks zu entfernen. Andernfalls wird er nicht erkannt.
