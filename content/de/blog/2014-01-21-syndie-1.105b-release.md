...
Alle Binärdateien und Quellpakete sind unter [syndie.de](https://syndie.de/download) und [syndie.i2p](http://www.syndie.i2p/download.html) verfügbar. Plugins sind verfügbar unter [plugins.i2p](http://plugins.i2p/plugins/syndie/) und [stats.i2p](http://stats.i2p/i2p/plugins/).
