...
resistencia de [SSU]_ a varias formas de identificación automática y ataques.
...
Como [SSU]_, también proporciona dos servicios adicionales:
...
- Soporte para SSU 1 y 2 en un solo puerto, detección automática, y publicado como un solo
  "transporte" (es decir, [RouterAddress]_) en el [NetDB]_.
...
- Arreglar la pérdida de bits en DH debido al formato de Java [Ticket1112]_, y acelerar el DH
  cambiando a X25519.
...
- Usar un mensaje de 3, ida y vuelta, como en [NTCP2]_.
  Eliminar la demora esperando por mensajes de datos que hace que
  [SSU]_ sea efectivamente un mensaje de ida y vuelta de dos rondas.
...
- Un transporte basado en TLS (o que simule HTTPS)... eso sería [Prop104]_.
...
protocolo Station-To-Station (STS) [STS]_. Note que este protocolo es también la
base para el protocolo [SSU]_.
...
Lo siguiente es copiado de QUIC [RFC-9000]_.
