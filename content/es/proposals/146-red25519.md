...
[Prop123]_ define un formato cifrado LeaseSet2 que encarna el Principio de Mínima
...
[RedDSA]_, un esquema de firma basado en Schnorr que admite la re-randomización de
...
B
    El punto base de Ed25519 como en [RFC-8032]_.

L
    El orden Ed25519 2^252 + 27742317777372353535851937790883648493 como en [RFC-8032]_.
...
deberían referirse a la sección 5.4.6 de [RedDSA]_ para la especificación general de
...
según lo especificado en los pasos 1-3 de la sección 5.1.5 de [RFC-8032]_.
