...
Esta propuesta describe un protocolo de acuerdo de claves autenticado para mejorar la resistencia de [NTCP](/docs/ntcp/) a diversas formas de identificación automatizada y ataques.
...
- Un transporte basado en TLS (o similar a HTTPS)... que sería [Prop104](/proposals/104-tls-transport/).
