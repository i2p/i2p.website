...
date: 2009-07-31
author: "zzz"
description: "I2P 0.7.6 release with network stability fixes, new console themes, and resource optimizations"
categories: ["release"]
---
...
The default tunnel length variance is changed from 1 to 0. This mainly affects exploratory tunnels and iMule. [As explained on zzz.i2p](http://zzz.i2p/topics/260), a non-zero variance adds very little protection, at great cost in resources. Should you wish to reconfigure your exploratory settings back to the old variance of 1, or change to length 3 variance 0, you may do so on the config tunnels page. iMule settings are best changed within that application.
