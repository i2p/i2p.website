...
date: 2013-03-08
author: "zzz"
description: "0.9.5 incluye correcciones de errores y protecciones frente a algunos problemas y vulnerabilidades que están siendo investigados por investigadores de la UCSB."
categories: ["release"]
---
...
En este ciclo de actualización, un 1% aleatorio de routers (más todos los routers que ejecuten una versión de desarrollo) intentará actualizarse mediante el bittorrent experimental dentro de la red con i2psnark. Si esto no funciona, debería recurrir a la actualización HTTP estándar dentro de la red.
...
### Defensas y correcciones de errores
