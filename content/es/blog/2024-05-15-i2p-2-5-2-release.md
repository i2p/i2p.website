...
date: 2024-05-15
author: "zzz"
description: "2.5.2 Lanzamiento con corrección de HTTP"
categories: ["release"]
API_Translate: verdadero
---

I2P 2.5.2 se ha publicado para corregir un error introducido en 2.5.0 que provocaba la truncación de algunos contenidos HTTP.
...
[Lista completa de errores corregidos](http://git.idk.i2p/i2p-hackers/i2p.i2p/-/issues?scope=all&state=closed&milestone_title=2.5.2)
