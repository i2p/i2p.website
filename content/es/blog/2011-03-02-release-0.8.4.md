...
date: 2011-03-02
author: "zzz"
description: "La versión 0.8.4 incluye algunas mejoras de rendimiento y correcciones de errores importantes. Además, i2psnark ahora admite enlaces magnet."
categories: ["release"]
---

La versión 0.8.4 incluye algunas mejoras de rendimiento y correcciones de errores importantes. Además, i2psnark ahora admite enlaces magnet. Como de costumbre, se recomienda actualizar.

Por favor, ayuda a hacer crecer la red. ¡[Participa](http://www.i2p2.de/getinvolved.html), corre la voz y [haz una donación](http://www.i2p2.de/donate.html)! Si encuentras un error, por favor registra un informe en [gitlab](http://i2pgit.org/i2p-hackers/i2p.i2p/issues). Seguimos buscando ayuda para traducciones nuevas y existentes. Por favor, ofrécete como voluntario en IRC #i2p-dev.
