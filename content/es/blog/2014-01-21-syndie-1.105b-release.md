...
Todos los binarios y paquetes de código fuente están en [syndie.de](https://syndie.de/download) y [syndie.i2p](http://www.syndie.i2p/download.html). Los plugins están disponibles en [plugins.i2p](http://plugins.i2p/plugins/syndie/) y [stats.i2p](http://stats.i2p/i2p/plugins/).
