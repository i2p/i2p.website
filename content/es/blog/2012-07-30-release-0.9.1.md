...
date: 2012-07-30
author: "zzz"
description: "0.9.1 incluye un gran número de correcciones de errores en i2psnark, algunas mejoras en la biblioteca de streaming, cambios en la página de inicio, nuevos temas y actualizaciones de las traducciones."
categories: ["release"]
---

La versión 0.9.1 incluye un gran número de correcciones de errores en i2psnark, algunas mejoras en la biblioteca de streaming, cambios en la página de inicio, nuevos temas y actualizaciones de las traducciones. Se recomienda actualizar.
