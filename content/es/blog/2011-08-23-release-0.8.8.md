...
date: 2011-08-23
author: "zzz"
description: "La versión 0.8.8 de I2P habilita la nueva base de datos hosts.txt para acelerar las búsquedas de nombres de host y almacenar información adicional en las entradas de nombre de host."
categories: ["release"]
---

La versión 0.8.8 de I2P habilita la nueva base de datos hosts.txt para acelerar la resolución de nombres de host y almacenar información adicional en las entradas de nombres de host. También incluye mejoras para acelerar la integración de un router durante el arranque. Hay nuevo código para detectar y reaccionar a grandes cambios en la hora del sistema, lo que debería ayudar a un router a recuperarse después de suspender y reanudar el equipo.

Hay nuevas traducciones al danés y al ucraniano y numerosas actualizaciones en otros idiomas. También se incluyen, por supuesto, numerosas correcciones de errores, mejoras de rendimiento y actualizaciones para hacer frente a la continua y rápida expansión de la red.

Por favor, ayuda a hacer crecer la red. ¡[Participa](http://www.i2p2.de/getinvolved.html), corre la voz y [dona](http://www.i2p2.de/donate.html)! Si encuentras un error, por favor envía un informe en [gitlab](http://i2pgit.org/i2p-hackers/i2p.i2p/issues). Seguimos buscando ayuda con traducciones nuevas y existentes. Por favor, ofrécete como voluntario en IRC #i2p-dev.
