---
title: "Instalación de I2P en Windows"
description: "Elija su método de instalación para Windows: Paquete de Instalación Fácil o Instalación Estándar"
lastUpdated: "2025-11"
toc: true
---
...
<a href="#easy-install-bundle" style="display: inline-block; background: #22c55e; color: white; padding: 0.75rem 1.5rem; border-radius: 4px; text-decoration: none; font-weight: bold; margin-top: 1rem;">Guía de Instalación Fácil →</a>
...
<a href="#standard-installation" style="display: inline-block; background: #1e40af; color: white; padding: 0.75rem 1.5rem; border-radius: 4px; text-decoration: none; font-weight: bold; margin-top: 1rem;">Guía de Instalación Estándar →</a>
...
![Selección de idioma](/images/guides/windows-install/language-selection.png)

1. **Elige tu idioma preferido** del menú desplegable
   - Los idiomas disponibles incluyen inglés, alemán, español, francés y muchos otros
2. Haz clic en **OK** para continuar
...
![Acuerdo de Licencia](/images/guides/windows-install/license-agreement.png)
...
![Selección de Carpeta de Instalación](/images/guides/windows-install/installation-folder.png)

**Opciones de instalación**:

1. **Usa la ubicación predeterminada** (recomendado)
   - Ruta predeterminada: `C:\Users\[YourUsername]\AppData\Local\I2peasy\`
   - Esto instala I2P en el directorio de tu perfil de usuario
   - No se requieren privilegios de administrador para las actualizaciones

2. **Elige una ubicación personalizada**
...
3. Haz clic en **Instalar** para comenzar el proceso de instalación
...
![Instalación Completada](/images/guides/windows-install/installation-complete.png)
...
1. **El I2P Router se inicia** - El router de I2P comienza a ejecutarse en segundo plano
2. **Aparece el icono en la bandeja del sistema** - Busca el icono de I2P en la bandeja del sistema de Windows (esquina inferior derecha)
3. **Se abre la consola del router** - Tu navegador web predeterminado se abrirá automáticamente en la Consola del I2P Router (normalmente en `http://127.0.0.1:7657`)
4. **Conexión inicial** - I2P comenzará a conectarse a la red y a construir tunnels (esto puede tomar de 5 a 10 minutos en el primer inicio)
...
1. **Localiza el icono de I2P** en la bandeja del sistema de Windows (área de notificaciones) en la parte inferior derecha de tu pantalla

![Menú de la bandeja del sistema de I2P](/images/guides/windows-install/system-tray-menu.png)

2. **Haz clic derecho en el icono de I2P** para abrir el menú contextual
3. **Haz clic en "Launch I2P Browser"** para abrir la consola del router I2P
...
1. **Navega a la página de configuración de red**:
   - Ve a [Configuración de Red del Router I2P](http://127.0.0.1:7657/confignet) en tu navegador
   - O desde la barra lateral de la consola del router: **Configuración → Red**

2. **Desplázate hacia abajo** hasta la sección de configuración de puertos

![Configuración de puertos de I2P](/images/guides/windows-install/port-configuration.png)

3. **Anote los números de puerto** mostrados:
...
Dado que cada router y firewall es diferente, no podemos proporcionar instrucciones universales. Sin embargo, [portforward.com](https://portforward.com/) tiene guías detalladas para miles de modelos de routers:

1. Visita **[portforward.com](https://portforward.com/)**
2. Selecciona el fabricante y modelo de tu router
3. Sigue la guía paso a paso para reenviar tu puerto
4. Reenvía **ambos protocolos UDP y TCP** en el número de puerto mostrado en tu configuración de I2P
...
**Opción 1: Oracle Java** - Fuente oficial: [java.com/download](https://www.java.com/download) - Distribución más utilizada

**Opción 2: OpenJDK** - Implementación de código abierto: [openjdk.org](https://openjdk.org) - Gratuito y de código abierto

**Opción 3: Adoptium (Eclipse Temurin)** - Alternativa recomendada: [adoptium.net](https://adoptium.net) - Versiones LTS gratuitas, de código abierto y bien mantenidas
...
1. **Elija una distribución de Java**:
...
2. **Descarga el instalador de Windows** para la distribución que hayas elegido

3. **Ejecuta el instalador** y sigue las indicaciones de instalación

4. **Verificar la instalación**:
   - Abrir el Símbolo del sistema
   - Escribir `java -version` y presionar Enter
   - Confirmar que Java 8 o superior esté instalado

Una vez que Java esté instalado, estarás listo para instalar I2P.

## Step 2: Download and Launch the I2P Installer

1. **Descarga el instalador de I2P**:
   - Visita la [página de descargas de I2P](/downloads/)
   - Descarga el **instalador para Windows** (archivo JAR): `i2pinstall_X.X.X.jar`
   - Guárdalo en una ubicación de fácil acceso (por ejemplo, la carpeta Descargas)
...
2. **Iniciar el instalador**:
   ...
   - Alternativamente, abre el Símbolo del sistema y ejecuta: `java -jar i2pinstall_X.X.X.jar`

## Step 3: Select Your Language

Después de ejecutar el instalador, verás el diálogo de Selección de Idioma.

![Selección de idioma](/images/guides/windows-standard-install/language-selection.png)

1. **Selecciona tu idioma preferido** del menú desplegable
   - Los idiomas disponibles incluyen inglés, alemán, español, francés y muchos otros
2. Haz clic en **OK** para continuar
...
![Pantalla de Bienvenida](/images/guides/windows-standard-install/welcome-screen.png)
...
![Acuerdo de Licencia](/images/guides/windows-standard-install/license-agreement.png)
...
![Ruta de instalación](/images/guides/windows-standard-install/installation-path.png)
...
![Ventana emergente de creación de directorio](/images/guides/windows-standard-install/directory-creation-popup.png)
...
![Seleccionar Paquetes](/images/guides/windows-standard-install/select-packs.png)
...
![Progreso de Instalación](/images/guides/windows-standard-install/installation-progress.png)
...
![Configurar accesos directos](/images/guides/windows-standard-install/setup-shortcuts.png)
...
![Instalación Completada](/images/guides/windows-standard-install/installation-complete.png)
...
1. **El router I2P se inicia** - Si instalaste el Servicio de Windows, I2P se iniciará automáticamente
2. **La consola del router se abre** - Tu navegador web predeterminado se abrirá en la Consola del Router I2P en `http://127.0.0.1:7657`
3. **Conexión inicial** - I2P comenzará a conectarse a la red y a construir tunnels (esto puede tomar de 5 a 10 minutos en el primer inicio)
...
![Menú Inicio de Windows](/images/guides/windows-standard-install/start-menu.png)

1. Abre el **Menú Inicio de Windows**
2. Navega a la carpeta **I2P**
3. Elige una de las opciones de inicio:
...
1. Presiona **Windows + R** para abrir el diálogo Ejecutar
2. Escribe `services.msc` y presiona Enter
3. Desplázate hacia abajo para encontrar **I2P Service**
4. Haz clic derecho en **I2P Service** y selecciona:
