...
I2P soporta una [interfaz de plugins](/docs/specs/plugin/) estándar para desarrolladores, de modo que las aplicaciones puedan integrarse y distribuirse fácilmente.
