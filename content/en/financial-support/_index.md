...
<div class="support-section">
  <h2><span class="icon">💜</span>Donate to I2P</h2>
...
<div class="support-section">
  <h2><span class="icon">🌱</span>Why I2P Needs Your Support</h2>
...
<div class="support-section">
  <h2><span class="icon">🚀</span>Sponsor Specific Development</h2>
  <div class="coming-soon">
    Coming soon - Community Crowdfunding System for targeted development projects
  </div>
</div>

<div class="support-section">
  <h2><span class="icon">🏢</span>Corporate & Institutional Support</h2>
  <div class="support-card">
    <p>
      Companies and organizations that benefit from I2P can support the project through corporate sponsorship. Sponsors can fund general operations, specific research initiatives, or community programs.
    </p>
    <p style="margin-top: 1rem;">
      <strong>Recognition tiers:</strong>
    </p>
    <ul class="support-list">
      <li>Bronze ($1,000+): Logo on website</li>
      <li>Silver ($5,000+): Logo + mention in release notes</li>
      <li>Gold ($10,000+): Logo + priority support for technical questions</li>
    </ul>
    <p style="margin-top: 1.5rem;">
      All corporate sponsors are reviewed to ensure alignment with I2P's privacy mission. Contact <strong>admin@i2p.net</strong> to discuss sponsorship opportunities.
    </p>
  </div>
</div>

<div class="support-section">
  <h2><span class="icon">📊</span>Financial Transparency</h2>
  <div class="info-box">
    <p>
...
<div class="support-section">
  <h2><span class="icon">🙏</span>Other Ways to Help</h2>
