---
title: "I2P Status Notes for 2005-04-19"
date: 2005-04-19
author: "jr"
...
Over the nearly two weeks since 0.5.0.6 came out, things have been mostly positive, though service providers (eepsites(I2P Sites), ircd, etc) have been running into some bugs as of late. While clients are in good shape, over time a server may run into situation where failing tunnels can trigger some excessive throttling code, preventing proper rebuilding and publication of the leaseSet.
...
There has been lots more going on as well, with some lively discussions on the mailing list, the forum, and irc. I'm not going to try to summarize those here, since there are only a few minutes until the meeting, but swing on by if there's something not discussed that you want to bring up!
