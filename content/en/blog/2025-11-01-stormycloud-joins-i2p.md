...
Starting now, you can support I2P development through cryptocurrency, credit/debit cards, and bank transfers. All donations go directly toward I2P: software development, infrastructure, research, and documentation. StormyCloud processes these as a 501(c)(3) nonprofit, making them tax-deductible for U.S. donors.

This partnership gives us more resources and stability to grow I2P while staying true to what makes it work: a decentralized, community-driven network that puts privacy first. I2P remains what it's always been: a community-driven project. Development happens in the open, decisions are made collectively, and the network exists because people choose to run it. That hasn't changed and won't change.
