...
We built these libraries to produce our I2P router libraries. They're spread out into multiple, focused repositories to ease review and make them useful to other people who want to build experimental, custom I2P routers.
...
You can write an I2P router for any reason, it's a free network, but it will help you to know why. Is there a community you want to empower, a tool you think is a good fit for I2P, or a strategy you want to try out? Figure out what your goal is to figure out where you need to start, and what a "finished" state will look like.
...
Whether you want to work in Rust, Go, Java, C++ or some other language, get in touch with us at #i2p-dev on Irc2P. Start there, and we'll onboard you to router-specific channels. We are also present on ramble.i2p at f/i2p, on reddit at r/i2p, and on GitHub and git.idk.i2p. We look forward to hearing from you soon.
