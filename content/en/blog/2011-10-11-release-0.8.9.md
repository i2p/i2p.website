...
date: 2011-10-11
author: "zzz"
description: "The 0.8.9 release has several performance improvements, and many changes to handle the continued rapid growth of the network."
categories: ["release"]
---
...
Please help grow the network. [Get involved](/get-involved), spread the word, and [donate](/en/get-involved/#donate)! If you find a bug, please enter a report on [Trac](http://trac.i2p2.i2p/report/1). We are still looking for help on new and existing translations. Please volunteer on IRC #i2p-dev.
