...
date: 2014-01-22
author: "zzz"
description: "0.9.10 changes the mechanism for doing LeaseSet lookups, making it more difficult for an attacker to correlate a Destination with a Router."
categories: ["release"]
---

0.9.10 changes the mechanism for doing LeaseSet lookups, making it more difficult for an attacker to correlate a Destination with a Router. It also fixes character encoding bugs in susimail, and includes lots of other bug fixes and translation updates. Most of you will update via torrent, using the new "su3" update format with stronger keys.

We recently attended [30C3](https://events.ccc.de/congress/2013/wiki/Main_Page) and [Real World Crypto](http://realworldcrypto.wordpress.com/), making several new connections and formulating [big plans](http://zzz.i2p) for 2014. Thanks to those who supported our attendance with their [donations](http://i2p-projekt.i2p/donate)!
