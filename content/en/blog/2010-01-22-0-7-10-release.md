...
date: 2010-01-22
author: "zzz"
description: "I2P version 0.7.10 released with security fixes for floodfill communication vulnerabilities"
categories: ["release"]
---
...
Also, to improve anonymity, router's fast peer set is now limited to a maximum of 30. The release also fixes a bug causing Windows installs to fail when the install or user path contained a "\r" or "\n". Upgrading is recommended. Please give the developers feedback on IRC #i2p or [forum.i2p2.de](http://forum.i2p2.de/) and [get involved](http://www.i2p2.de/getinvolved.html) or [donate](http://www.i2p2.de/donate.html)! We are still looking for help on new and existing translations. Please volunteer on IRC #i2p.
