...
First, follow the [Git guide for Users](/docs/applications/git/) until you have a successfully `--unshallow`ed clone of the i2p.i2p repository. If you already have a clone, make sure you run `git fetch --unshallow` before you generate a torrent bundle.
