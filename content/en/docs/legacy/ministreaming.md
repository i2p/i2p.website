...
"full" [streaming library](/docs/api/streaming).
...
[I2CP](/docs/protocol/i2cp) that allows reliable, in order, and authenticated streams
...
[I2PTunnel](/docs/api/i2ptunnel) application and then factored out and released
...
[SAM](/docs/api/samv3)'s streaming support.
