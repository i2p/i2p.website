...
Developers may push changes to a distributed git repository if you receive permission from the person running that repository. See the [New Developer Guide](/docs/develop/new-developers/) for details.
