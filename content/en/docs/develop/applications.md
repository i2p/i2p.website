...
Using <a href="/docs/api/i2ptunnel/">I2PTunnel</a>,
you can use regular applications without needing to program explicit I2P support.
This is very effective for client-server scenarios,
...
<div class="box" id="tunnel.serverclient" style="text-align:center">
  <img src="/images/i2ptunnel_serverclient.png" alt="Creating a server-client connection using I2PTunnel only requires creating a single tunnel." title="Creating a server-client connection using I2PTunnel only requires creating a single tunnel." />
  <br /><br />
...
<div class="box" id="tunnel.peertopeer" style="text-align:center">
  <img src="/images/i2ptunnel_peertopeer.png" alt="Setting up connections for a peer-to-peer applications requires a very large amount of tunnels." title="Setting up connections for a peer-to-peer applications requires a very large amount of tunnels." />
  <br /><br />
...
<p>
I2P supports a standard <a href="/docs/plugins/">plugins interface</a> for developers
...
<a href="/docs/overview/naming/">Further information on the naming system</a> is available.
</p>
</li>
</ul>
...
See the <a href="/docs/api/datagrams/">datagram page</a> for details.
...
<h3>Streaming Lib</h3>
<p>
The <a href="/spec/api/streaming/">full streaming library</a> is now the standard
...
<h3>BOB</h3>
<p>
BOB is the <a href="/docs/legacy/bob/">Basic Open Bridge</a>,
...
found at this <a href="http://bob.i2p/">I2P Site</a>.
</p>
...
<p>
SAM is the <a href="/docs/legacy/sam/">Simple Anonymous Messaging</a> protocol, allowing an
...
<li>raw datagrams, for when Alice wants to squeeze the most bandwidth and performance as possible, and Bob doesn't care whether the data's sender is authenticated or not (e.g. the data transferred is self authenticating)</li>
</ul>
<p>
...
<p>
<a href="/docs/legacy/samv2/">SAM V2</a> is a new version used by imule that fixes some of the problems in <a href="/docs/legacy/sam/">SAM</a>.
<br />
<a href="/docs/api/samv3/">SAM V3</a> is used by imule since version 1.4.0.
</p>
...
<p>
The <a href="/docs/api/datagrams/">Datagram library</a> allows sending UDP-like packets.
...
<p>
<a href="/docs/specs/i2cp/">I2CP</a> itself is a language independent protocol, but to implement an I2CP library 
...
<div class="box">
<pre><code class="language-java">// Server example (excerpt)
...
<p style="text-align:center">Code example: basic server receiving data.</p>
</div>

<div class="box">
<pre><code class="language-java">// Client example (excerpt)
I2PSocketManager manager = I2PSocketManagerFactory.createManager();
...
<p style="text-align:center">Code example: client connecting and sending a line.</p>
</div>
