---
title: "Addressbook Subscription Feed Commands"
description: "Specification for extending the address subscription feed with commands to enable name servers to broadcast entry updates from hostname holders."
slug: "subscription"
aliases:
  - /docs/specs/subscription-spec/
category: "Formats"
lastUpdated: "2021-01"
accurateFor: "0.9.49"
---
...
**oldsig**
: A second b64 signature, using signing key from olddest
...
All commands must contain a signature key/value `sig=b64signature` where the signature is for the other data, using the destination signing key.
