...
- Add a checksum.
- Addresses for encrypted leasesets are identified by 56 or more encoded
  characters (35 or more decoded bytes), compared to 52 characters (32
  bytes) for traditional base 32 addresses.
...
- Don't expect 2-byte sigtypes to ever happen, we're only up to 13. No
...
- [CRC-32](https://en.wikipedia.org/wiki/CRC-32) - see also [RFC 3309](https://tools.ietf.org/html/rfc3309)
