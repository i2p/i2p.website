...
resistance of [SSU](/en/docs/transport/ssu/) to various forms of automated identification and attacks.
...
Like [SSU](/en/docs/transport/ssu/), it also provides two additional services:
...
- Support SSU 1 and 2 on a single port, auto-detect, and published as a single
  "transport" (i.e. RouterAddress) in the [NetDB](/en/docs/how/network-database/).
...
- Use a 3-message, one-round-trip handshake, as in [NTCP2](/en/docs/spec/ntcp2/).
  Remove the delay waiting for data messages that makes
  [SSU](/en/docs/transport/ssu/) effectively a two-round-trip handshake.
...
- Bullet-proof DPI resistance... that would be pluggable transports,
  [Proposal 109](/en/proposals/109-pt-transport/).

- A TLS-based (or HTTPS-lookalike) transport... that would be [Proposal 104](/en/proposals/104-tls-transport/).
...
basis for the [SSU](/en/docs/transport/ssu/) protocol.
...
* Threat models: From NTCP2 [NTCP2](/en/docs/spec/ntcp2/), with significant additional threats
...
* Cryptographic choices: From [NTCP2](/en/docs/spec/ntcp2/).

* Handshake: Noise XK from [NTCP2](/en/docs/spec/ntcp2/) and [NOISE](https://noiseprotocol.org/noise.html). Significant simplifications
  to NTCP2 are possible due to the encapsulation (inherent message boundaries)
  provided by UDP.

* Handshake ephemeral key obfuscation: Adapted from [NTCP2](/en/docs/spec/ntcp2/)
  but using ChaCha20 from [ECIES](/en/docs/spec/ecies/) instead of AES.
...
* Packet header obfuscation: Adapted from [NTCP2](/en/docs/spec/ntcp2/)
  but using ChaCha20 from [ECIES](/en/docs/spec/ecies/) instead of AES.
...
* Headers used as AEAD associated data as in [ECIES](/en/docs/spec/ecies/).
...
* Messages: Adapted from [SSU](/en/docs/transport/ssu/)

* I2NP Fragmentation: Adapted from [SSU](/en/docs/transport/ssu/)

* Relay and Peer Testing: Adapted from [SSU](/en/docs/transport/ssu/)

* Signatures of Relay and Peer Test data: From the common structures spec [Common](/en/docs/spec/common-structures/)

* Block format: From [NTCP2](/en/docs/spec/ntcp2/) and [ECIES](/en/docs/spec/ecies/).

* Padding and options: From [NTCP2](/en/docs/spec/ntcp2/) and [ECIES](/en/docs/spec/ecies/).
...
Station-To-Station (STS) protocol, which is the basis for the [SSU](/en/docs/transport/ssu/) protocol.  In Noise parlance, Alice
...
This uses the same block format as defined in the [NTCP2](/en/docs/spec/ntcp2/) and [ECIES](/en/docs/spec/ecies/) specifications.
...
This format is identical to that in [NTCP2](/en/docs/spec/ntcp2/) and [ECIES](/en/docs/spec/ecies/),
...
as in [NTCP2](/en/docs/spec/ntcp2/) (type, message id, short expiration).
...
- The padding length is either to be decided on a per-message basis and
  ...
  of [NTCP2](/en/docs/spec/ntcp2/) provides more information on the topic.
...
[Proposal 158](/en/proposals/158-ipv6-transport-enhancements/) and supported as of 0.9.50.
...
including changes in [Proposal 158](/en/proposals/158-ipv6-transport-enhancements/) supported as of API 0.9.50:
