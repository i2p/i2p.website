...
resistance of [NTCP](/en/docs/transport/ntcp/) to various forms of automated identification and attacks.
...
[NTCP](/en/docs/transport/ntcp/) data is encrypted after the first message (and the first message
...
an existing protocol such as TLS, but this is [Prop104](/en/proposals/104/) and it has problems of
...
- Fix loss of bits in DH due to Java format [Ticket1112](https://trac.i2p2.i2p/ticket/1112), possibly (probably?)
...
- If possible, reduce the 4-message, two-round-trip handshake to a 3-message,
  one-round-trip handshake, as in [SSU](/en/docs/transport/ssu/). This would require moving Bob's
...
- A TLS-based (or HTTPS-lookalike) transport... that would be [Prop104](/en/proposals/104/).
...
which is the basis for the [SSU](/en/docs/transport/ssu/) protocol.  In Noise parlance, Alice
...
* [1](http://www.chesworkshop.org/ches2009/presentations/01_Session_1/CHES2009_ekasper.pdf) "Faster and Timing-Attack Resistant AES-GCM" by Emilia Käsper and Peter Schwabe
* [2](https://www.blackhat.com/docs/us-16/materials/us-16-Devlin-Nonce-Disrespecting-Adversaries-Practical-Forgery-Attacks-On-GCM-In-TLS.pdf) "Nonce-Disrespecting Adversaries: Practical Forgery Attacks on GCM in TLS" by H. Böck, A. Zauner, S. Devlin, J. Somorovsky, P. Jovanovic
* [3](https://eprint.iacr.org/2014/613.pdf) "CAESAR submission: Ketje" by Guido Bertoni, Joan Daemen, Michaël Peeters, Gilles Van Assche, Ronny Van Keer
* [4](https://www.imperialviolet.org/2013/10/07/chacha20.html) "ChaCha20 and Poly1305 for IETF protocols" by Adam Langley
* [5](https://tools.ietf.org/html/rfc7539) RFC 7539
