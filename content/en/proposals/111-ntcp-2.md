...
See [SPEC](/docs/specs/ntcp2/) for the official specification.
...
resistance of [NTCP](/docs/legacy/ntcp/) to various forms of automated identification and attacks.
...
[NTCP](/docs/legacy/ntcp/) data is encrypted after the first message (and the first message
...
an existing protocol such as TLS, but this is [Prop104](/proposals/104/) and it has problems of
...
- If possible, reduce the 4-message, two-round-trip handshake to a 3-message,
  one-round-trip handshake, as in [SSU](/docs/specs/ssu2/). This would require moving Bob's
...
- A TLS-based (or HTTPS-lookalike) transport... that would be [Prop104](/proposals/104/).
...
which is the basis for the [SSU](/docs/specs/ssu2/) protocol.  In Noise parlance, Alice
...
* ["Faster and Timing-Attack Resistant AES-GCM" by Emilia Käsper and Peter Schwabe](http://www.chesworkshop.org/ches2009/presentations/01_Session_1/CHES2009_ekasper.pdf)
