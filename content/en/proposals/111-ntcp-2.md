...
resistance of [NTCP](/docs/ntcp/) to various forms of automated identification and attacks.
...
[NTCP](/docs/ntcp/) data is encrypted after the first message (and the first message
...
an existing protocol such as TLS, but this is [Prop104](/proposals/104-tls-transport/) and it has problems of
...
- A TLS-based (or HTTPS-lookalike) transport... that would be [Prop104](/proposals/104-tls-transport/).
