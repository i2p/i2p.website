...
See the [official specification](/docs/specs/red25519-signature-scheme/) for more details.
...
[Proposal 123](/proposals/123-new-netdb-entries/) defines an encrypted LeaseSet2 format that embodies the Principle of Least
...
Proposal 123 achieves this by blinding the signing keys of Destinations. The blinded keys can
...
RedDSA, a Schnorr-based signature scheme that supports key re-randomization. It has
...
B
    The Ed25519 basepoint as in [RFC-8032](https://tools.ietf.org/html/rfc8032).

L
    The Ed25519 order 2^252 + 27742317777372353535851937790883648493 as in [RFC-8032](https://tools.ietf.org/html/rfc8032).
...
byte array and coordinate forms of a point.
...
to section 5.4.6 of the RedDSA specification for the general specification of the RedDSA functions.
...
private key, as specified in in steps 1-3 from section 5.1.5 of [RFC-8032](https://tools.ietf.org/html/rfc8032).
...
* [SPEC](/docs/specs/red25519-signature-scheme/)
